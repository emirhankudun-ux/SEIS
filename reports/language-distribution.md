...
- Counted files: 863
- Counted bytes: 4826346
- JavaScript: 1704556 bytes (35.32%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3290587

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1704556 | 35.32% | JavaScript |
| TypeScript | 411787 | 8.53% | TypeScript |
| Objective-C | 8447 | 0.18% | Objective-C |
| Other | 2701556 | 55.98% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 12.09% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 27.25% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 43.85% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
