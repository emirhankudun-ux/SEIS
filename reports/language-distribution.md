...
- Counted files: 856
- Counted bytes: 4804441
- JavaScript: 1686637 bytes (35.11%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3227163

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1686637 | 35.11% | JavaScript |
| TypeScript | 411787 | 8.57% | TypeScript |
| Objective-C | 8447 | 0.18% | Objective-C |
| Other | 2697570 | 56.15% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| AI, Data, Python, SQL | 27.34% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 43.68% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| HTML / CSS previews | 8.94% | 0.0-3.0% | `above_target` | HTML, CSS |
...
| `apps/seis-core/script.js` | 35287 |
