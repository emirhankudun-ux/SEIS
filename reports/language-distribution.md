...
- Counted files: 903
- Counted bytes: 5345058
- JavaScript: 1999383 bytes (37.41%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 4175813

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1999383 | 37.41% | JavaScript |
| TypeScript | 411787 | 7.7% | TypeScript |
| Objective-C | 8447 | 0.16% | Objective-C |
| Other | 2925441 | 54.73% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| AI, Data, Python, SQL | 28.57% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 45.11% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| `scripts/create-ai-core-fixture-evaluation-report.mjs` | 28031 |
