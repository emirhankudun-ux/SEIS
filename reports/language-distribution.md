...
- Counted files: 856
- Counted bytes: 4799099
- JavaScript: 1682245 bytes (35.05%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3211591

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1682245 | 35.05% | JavaScript |
| TypeScript | 411787 | 8.58% | TypeScript |
| Objective-C | 8447 | 0.18% | Objective-C |
| Other | 2696620 | 56.19% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 12.16% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 27.37% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 43.63% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| HTML / CSS previews | 8.93% | 0.0-3.0% | `above_target` | HTML, CSS |
...
| `apps/seis-core/script.js` | 32268 |
