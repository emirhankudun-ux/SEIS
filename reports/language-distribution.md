...
- Counted files: 903
- Counted bytes: 5339990
- JavaScript: 1994315 bytes (37.35%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 4156748

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1994315 | 37.35% | JavaScript |
| TypeScript | 411787 | 7.71% | TypeScript |
| Objective-C | 8447 | 0.16% | Objective-C |
| Other | 2925441 | 54.78% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| TypeScript / JavaScript tooling | 45.06% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| `scripts/create-ai-core-fixture-evaluation-report.mjs` | 27320 |
