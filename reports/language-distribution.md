...
- Counted files: 865
- Counted bytes: 4838939
- JavaScript: 1716677 bytes (35.48%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3335713
...
| Other | 2702028 | 55.84% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| AI, Data, Python, SQL | 27.19% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
