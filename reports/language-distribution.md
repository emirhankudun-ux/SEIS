...
- Counted files: 934
- Counted bytes: 5477953
- JavaScript: 2187085 bytes (39.93%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 4936737

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 2187085 | 39.93% | JavaScript |
| TypeScript | 424439 | 7.75% | TypeScript |
| Objective-C | 8447 | 0.15% | Objective-C |
| Other | 2857982 | 52.17% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 10.65% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 25.75% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 47.67% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| HTML / CSS previews | 8.77% | 0.0-3.0% | `above_target` | HTML, CSS |

Unassigned counted languages: 3.0% (ABAP, AWK, Ada, Avro, Batchfile, CEL, CMake, COBOL, Cairo, Common Lisp, Crystal, D, +46 more).

## Counted Languages

| Language | Bytes | Percent |
| --- | ---: | ---: |
| JavaScript | 2187085 | 39.93% |
| JSON | 884770 | 16.15% |
| Swift | 574078 | 10.48% |
| Python | 507049 | 9.26% |
| TypeScript | 424439 | 7.75% |
| CSS | 321721 | 5.87% |
| HTML | 158454 | 2.89% |
| Shell | 97083 | 1.77% |
| YAML | 44308 | 0.81% |
