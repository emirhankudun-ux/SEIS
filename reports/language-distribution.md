...
- Counted files: 903
- Counted bytes: 5343145
- JavaScript: 1997470 bytes (37.38%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 4168616

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1997470 | 37.38% | JavaScript |
| TypeScript | 411787 | 7.71% | TypeScript |
| Objective-C | 8447 | 0.16% | Objective-C |
| Other | 2925441 | 54.75% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| HTML / CSS previews | 8.19% | 0.0-3.0% | `above_target` | HTML, CSS |
...
| `scripts/create-ai-core-fixture-evaluation-report.mjs` | 27904 |
