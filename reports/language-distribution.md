...
- Counted files: 891
- Counted bytes: 5095518
- JavaScript: 1835370 bytes (36.02%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3644339

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1835370 | 36.02% | JavaScript |
| TypeScript | 411787 | 8.08% | TypeScript |
| Objective-C | 8447 | 0.17% | Objective-C |
| Other | 2839914 | 55.73% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 11.45% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 28.44% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 44.1% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| HTML / CSS previews | 8.44% | 0.0-3.0% | `above_target` | HTML, CSS |

Unassigned counted languages: 3.21% (ABAP, AWK, Ada, Avro, Batchfile, CEL, CMake, COBOL, Cairo, Common Lisp, Crystal, D, +46 more).

## Counted Languages

| Language | Bytes | Percent |
| --- | ---: | ---: |
| JavaScript | 1835370 | 36.02% |
| JSON | 922657 | 18.11% |
| Swift | 574078 | 11.27% |
| Python | 507341 | 9.96% |
| TypeScript | 411787 | 8.08% |
| CSS | 287825 | 5.65% |
| HTML | 142030 | 2.79% |
| Shell | 97083 | 1.91% |
| Other | 41564 | 0.82% |
...
| `apps/seis-core/ai-core-contract-fixture.js` | 29733 |
