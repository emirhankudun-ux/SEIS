...
- Counted files: 876
- Counted bytes: 4973450
- JavaScript: 1750251 bytes (35.19%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3361078

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1750251 | 35.19% | JavaScript |
| TypeScript | 411787 | 8.28% | TypeScript |
| Objective-C | 8447 | 0.17% | Objective-C |
| Other | 2802965 | 56.36% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 11.73% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 28.39% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
...
| HTML / CSS previews | 8.64% | 0.0-3.0% | `above_target` | HTML, CSS |

Unassigned counted languages: 3.28% (ABAP, AWK, Ada, Avro, Batchfile, CEL, CMake, COBOL, Cairo, Common Lisp, Crystal, D, +46 more).

## Counted Languages

| Language | Bytes | Percent |
| --- | ---: | ---: |
| JavaScript | 1750251 | 35.19% |
| JSON | 826264 | 16.61% |
| Swift | 574078 | 11.54% |
| Python | 566785 | 11.4% |
| TypeScript | 411787 | 8.28% |
| CSS | 287825 | 5.79% |
| HTML | 142030 | 2.86% |
| Shell | 97083 | 1.95% |
| Other | 41564 | 0.84% |
