...
- Counted files: 859
- Counted bytes: 4804918
- JavaScript: 1688655 bytes (35.14%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 3236296

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 1688655 | 35.14% | JavaScript |
| TypeScript | 411787 | 8.57% | TypeScript |
| Objective-C | 8447 | 0.18% | Objective-C |
| Other | 2696029 | 56.11% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 12.14% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 27.35% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 43.71% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| Go / Infrastructure | 3.23% | 5.0-8.0% | `below_target` | Go, Shell, YAML, HCL, TOML, Bicep, Nix, CUE, Rego, Dockerfile |
| Windows / .NET | 0.17% | 5.0-8.0% | `below_target` | C#, F#, Visual Basic, PowerShell |
| HTML / CSS previews | 8.88% | 0.0-3.0% | `above_target` | HTML, CSS |
...
| --- | ---: | ---: |
| JavaScript | 1688655 | 35.14% |
| JSON | 788276 | 16.41% |
| Swift | 574078 | 11.95% |
| Python | 506913 | 10.55% |
| TypeScript | 411787 | 8.57% |
| CSS | 287432 | 5.98% |
| HTML | 139289 | 2.9% |
| Shell | 92418 | 1.92% |
| Other | 42047 | 0.88% |
