...
- Counted files: 912
- Counted bytes: 5352157
- JavaScript: 2095802 bytes (39.16%)
- Target JavaScript: 21.0%
- Target status: `above_target`
- Additional non-JavaScript bytes needed for strict target: 4627852

## GitHub Language Panel Split

| Panel | Bytes | Percent | Source languages |
| --- | ---: | ---: | --- |
| JavaScript | 2095802 | 39.16% | JavaScript |
| TypeScript | 424439 | 7.93% | TypeScript |
| Objective-C | 8447 | 0.16% | Objective-C |
| Other | 2823469 | 52.75% | ABAP, AWK, Ada, AppleScript, Avro, Batchfile, Bicep, C, C#, C++, CEL, CMake, +81 more |
...
| --- | ---: | ---: | --- | --- |
| Apple / Swift ecosystem | 10.9% | 25.0-30.0% | `below_target` | Swift, Objective-C, AppleScript |
| AI, Data, Python, SQL | 25.94% | 18.0-22.0% | `above_target` | Python, SQL, R, Julia, Scala, JSON, JSON-LD, Turtle, SPARQL |
| TypeScript / JavaScript tooling | 47.09% | 15.0-20.0% | `above_target` | TypeScript, JavaScript |
...
| --- | ---: | ---: |
| JavaScript | 2095802 | 39.16% |
| JSON | 862564 | 16.12% |
| Swift | 574078 | 10.73% |
| Python | 506913 | 9.47% |
| TypeScript | 424439 | 7.93% |
| CSS | 318194 | 5.95% |
| HTML | 156152 | 2.92% |
| Shell | 92418 | 1.73% |
| YAML | 43436 | 0.81% |
