...
- MCP runtime: 34 tools, 30 resources, 4 prompts over stdio JSON-RPC
...
| Prompt registry | verified | 4 | Provide bounded audit, i18n, locale, and Second Brain review prompts without embedding secrets. |
