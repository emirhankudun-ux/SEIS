...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 2078422 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
| 2 | TypeScript | frontend-and-experience | 423427 | polyglot/typescript/seis_config_validator.ts, polyglot/typescript/language-split-contract.ts, packages/seis-ai/types/seis-ai.d.ts |
...
| 51 | HTML | frontend-and-experience | 156078 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 318194 | apps/web/style.css, apps/web/styles.css |
