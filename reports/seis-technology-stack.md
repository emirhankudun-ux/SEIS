...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 1682245 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
...
| 51 | HTML | frontend-and-experience | 139920 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 288516 | apps/web/style.css, apps/web/styles.css |
