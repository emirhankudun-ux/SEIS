...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 852070 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
...
| 4 | Python | backend-and-api | 300155 | polyglot/python/seis_manifest.py, polyglot/python/seis_image_audit.py, polyglot/python/seis_icon_gen.py, polyglot/python/seis_color_contrast.py, polyglot/python/seis_sw_cache_audit.py, server/python/verify_release.py |
| 5 | Swift | mobile-and-native | 248773 | polyglot/swift/SEISMotionPolicy.swift |
...
| 9 | Kotlin | mobile-and-native | 1150 | polyglot/kotlin/SeisMotionPolicy.kt, polyglot/kotlin/seis_css_font_audit.kts |
| 10 | Dart | mobile-and-native | 532 | polyglot/dart/seis_motion_policy.dart |
| 11 | PHP | backend-and-api | 8471 | polyglot/php/contact-endpoint.php, server/php/health.php, server/php/router.php |
| 12 | Ruby | backend-and-api | 13442 | polyglot/ruby/verify_release.rb, polyglot/ruby/i18n_stats.rb, polyglot/ruby/html_heading_audit.rb, polyglot/ruby/favicon_audit.rb |
...
| 15 | C# | backend-and-api | 2731 | polyglot/csharp/SeisReleaseContract.cs |
| 16 | SQL | database-and-data | 8177 | polyglot/sql/audit_ledger.sqlite.sql |
| 17 | Shell | cloud-devops-and-config | 56789 | polyglot/bash/deploy_guard.sh, scripts/polyglot-check.sh |
| 18 | PowerShell | cloud-devops-and-config | 2176 | polyglot/powershell/SeisReleasePolicy.ps1 |
...
| 51 | HTML | frontend-and-experience | 84633 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 94204 | apps/web/style.css, apps/web/styles.css |
