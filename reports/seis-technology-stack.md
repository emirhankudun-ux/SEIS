...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 2210558 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
...
| 4 | Python | backend-and-api | 507065 | polyglot/python/seis_manifest.py, polyglot/python/seis_image_audit.py, polyglot/python/seis_icon_gen.py, polyglot/python/seis_color_contrast.py, polyglot/python/seis_sw_cache_audit.py, server/python/verify_release.py |
...
| 17 | Shell | cloud-devops-and-config | 97489 | polyglot/bash/deploy_guard.sh, scripts/polyglot-check.sh |
...
| 51 | HTML | frontend-and-experience | 158454 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 321721 | apps/web/style.css, apps/web/styles.css |
