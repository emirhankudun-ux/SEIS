...
| 4 | Python | backend-and-api | 294869 | polyglot/python/seis_manifest.py, polyglot/python/seis_image_audit.py, polyglot/python/seis_icon_gen.py, polyglot/python/seis_color_contrast.py, polyglot/python/seis_sw_cache_audit.py, server/python/verify_release.py |
| 5 | Swift | mobile-and-native | 151740 | polyglot/swift/SEISMotionPolicy.swift |
