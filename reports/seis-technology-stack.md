...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 2502166 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
...
| 17 | Shell | cloud-devops-and-config | 98334 | polyglot/bash/deploy_guard.sh, scripts/polyglot-check.sh |
...
| 51 | HTML | frontend-and-experience | 167816 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 327008 | apps/web/style.css, apps/web/styles.css |
