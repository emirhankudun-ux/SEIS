...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 1777765 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
| 2 | TypeScript | frontend-and-experience | 419656 | polyglot/typescript/seis_config_validator.ts, polyglot/typescript/language-split-contract.ts, packages/seis-ai/types/seis-ai.d.ts |
