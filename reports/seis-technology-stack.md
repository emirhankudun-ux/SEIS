...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 1923385 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
...
| 4 | Python | backend-and-api | 507341 | polyglot/python/seis_manifest.py, polyglot/python/seis_image_audit.py, polyglot/python/seis_icon_gen.py, polyglot/python/seis_color_contrast.py, polyglot/python/seis_sw_cache_audit.py, server/python/verify_release.py |
...
| 51 | HTML | frontend-and-experience | 147094 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 290352 | apps/web/style.css, apps/web/styles.css |
