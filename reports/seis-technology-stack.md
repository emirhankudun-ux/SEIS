...
| ---: | --- | --- | ---: | --- |
| 1 | JavaScript | frontend-and-experience | 2620692 | apps/web/src/scripts/motion-system.js, apps/web/src/scripts/gallery-system.js, apps/web/src/scripts/i18n-system.js, polyglot/javascript/plugin-source-runtime.js |
...
| 17 | Shell | cloud-devops-and-config | 98373 | polyglot/bash/deploy_guard.sh, scripts/polyglot-check.sh |
...
| 31 | Zig | mobile-and-native | 712 | polyglot/zig/readiness_contract.zig |
...
| 34 | D | mobile-and-native | 456 | polyglot/d/readiness_policy.d |
...
| 51 | HTML | frontend-and-experience | 252871 | apps/web/index.html, apps/web/seis-cockpit.html |
| 52 | CSS | frontend-and-experience | 365496 | apps/web/style.css, apps/web/styles.css |
