...
| Command Center | Scaffolded/planned | `docs/product/command-center-foundation.md`, `apps/web/goal-tracking.html`, `apps/web/seis-cockpit.html#plugin-interfaces` | Broader modules are not implemented. | Keep lane status generated from source records. |
