...
| `npm run check:goal-tracking` | Passed | 20 goals, 20 categories, 10 evidence records, 3 tasks, 2 blockers, 2 decisions, 3 review records, 3 completed items, 3 deferred items, 3 follow-up actions, 4 horizons, 3 projects, 3 epics, 3 subtasks, 3 archive items, goal metadata fields, generated view model, and static page validate. |
