...
| `npm run check:goal-tracking` | Passed | Goal registry, evidence ledger, execution board, review cadence, review log, planning horizons, progress ledger, objective coverage, completion gate, requirement matrix, generated Command Center view model, static Goal Tracking page, and Command Center shell docs validate locally; current counts include 20 evidence records, 3 performed review logs, 10 completed items, and 22 requirement matrix records. |
