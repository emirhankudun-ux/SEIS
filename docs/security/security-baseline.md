...
| AI provider keys | Audited statically | `docs/audits/AI_PROVIDER_AND_CREDENTIAL_AUDIT.md`, `docs/audits/ai-provider-audit.json` | No runtime verification or history scan was performed. | Add typed server-only environment validation before live adapters. |
