...
| `npm run check:goal-tracking` | Passed | Structured goal registry, evidence ledger, required docs, statuses, blockers, evidence links, and validation rules passed. |
