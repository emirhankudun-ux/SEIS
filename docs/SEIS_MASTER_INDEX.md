...
| SEIS-SSH docs | [../SEIS_SSH.md](../SEIS_SSH.md), [OBSIDIAN_SECOND_BRAIN.md](OBSIDIAN_SECOND_BRAIN.md), [SEIS_SSH_SETUP.md](SEIS_SSH_SETUP.md), [LOCAL_AI_SETUP.md](LOCAL_AI_SETUP.md), [../SEIS_CLOUD_AND_SSH.md](../SEIS_CLOUD_AND_SSH.md), [docs/cloud-ssh/*](docs/cloud-ssh) |
...
| Obsidian vault safety | [OBSIDIAN_SECOND_BRAIN.md](OBSIDIAN_SECOND_BRAIN.md), [../SEIS_OBSIDIAN_VAULT.md](../SEIS_OBSIDIAN_VAULT.md), [../SEIS_SECOND_BRAIN.md](../SEIS_SECOND_BRAIN.md) |
...
| SEIS fresh-clone readiness gate | `npm run check:seis-ai-fresh-clone-readiness` |
...
| Brain check alias | `npm run brain:check` |
| Public readiness alias | `npm run public:readiness` |
| Secrets check alias | `npm run secrets:check` |
