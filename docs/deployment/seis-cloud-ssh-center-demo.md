...
The route renders a `browserLocalHandoffPacket` with id
`seis-cloud-ssh-center-mobile-handoff-packet`. The packet is generated by
`apps/seis-core/cloud-ssh-center.js`, includes no secrets, performs no remote
