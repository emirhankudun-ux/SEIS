...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `SEIS-GOAL-001` | Build SEIS Command Center as the central operating interface. | SEIS App / Command Center | P1 high | planned | Platform foundation | [`../architecture/COMMAND_CENTER_FOUNDATION_REVIEW.md`](../architecture/COMMAND_CENTER_FOUNDATION_REVIEW.md) | Build static/manual Command Center views from docs and fixture data. |
| `SEIS-GOAL-002` | Establish SEIS Goal Tracking OS. | Goal Tracking OS | P1 high | active | Goal foundation | [`goal-tracking-system.md`](goal-tracking-system.md), [`evidence-ledger.md`](evidence-ledger.md), [`execution-board.md`](execution-board.md) | Keep goal, evidence, and execution registries validated, then render them in Command Center. |
...
| SEIS App / Command Center | planned/partial | Static/manual UI plan | Complete app not proven | [`../architecture/COMMAND_CENTER_FOUNDATION_REVIEW.md`](../architecture/COMMAND_CENTER_FOUNDATION_REVIEW.md) |
| Goal Tracking OS | active | Evidence-backed execution registry | No app implementation yet | [`goal-tracking-system.md`](goal-tracking-system.md), [`evidence-ledger.md`](evidence-ledger.md), [`execution-board.md`](execution-board.md) |
