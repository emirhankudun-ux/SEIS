...
| `SEIS-GOAL-002` | Establish SEIS Goal Tracking OS. | Goal Tracking OS | P1 high | active | Goal foundation | [`goal-tracking-system.md`](goal-tracking-system.md), [`evidence-ledger.md`](evidence-ledger.md) | Keep goal and evidence registries validated, then render them in Command Center. |
...
| Goal Tracking OS | active | Evidence-backed registry | No app implementation yet | [`goal-tracking-system.md`](goal-tracking-system.md), [`evidence-ledger.md`](evidence-ledger.md) |
