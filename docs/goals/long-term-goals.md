...
| `SEIS-GOAL-002` | Establish SEIS Goal Tracking OS. | Goal Tracking OS | P1 high | active | Goal foundation | [`goal-tracking-system.md`](goal-tracking-system.md), [`evidence-ledger.md`](evidence-ledger.md), [`execution-board.md`](execution-board.md), [`command-center-view-model.md`](command-center-view-model.md) | Keep goal, evidence, execution, and view registries validated, then render them in Command Center. |
