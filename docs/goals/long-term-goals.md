...
| `SEIS-GOAL-019` | Maintain long-term product vision and review cadence. | Long-Term Product Vision | P1 high | active | Foundation | [`seis-vision.md`](seis-vision.md), [`review-cadence.md`](review-cadence.md), [`daily-review-template.md`](daily-review-template.md) | Keep cadence records planned until daily/weekly/monthly reviews are performed with evidence. |
