...
| `SEIS-GOAL-002` | Establish SEIS Goal Tracking OS. | Goal Tracking OS | P1 high | active | Goal foundation | [`goal-tracking-system.md`](goal-tracking-system.md), [`evidence-ledger.md`](evidence-ledger.md), [`execution-board.md`](execution-board.md), [`review-cadence.md`](review-cadence.md), [`command-center-view-model.md`](command-center-view-model.md) | Keep goal, evidence, execution, review cadence, and view registries validated, then render them in Command Center. |
...
| `SEIS-GOAL-019` | Maintain long-term product vision and review cadence. | Long-Term Product Vision | P1 high | active | Foundation | [`seis-vision.md`](seis-vision.md), [`review-cadence.md`](review-cadence.md) | Keep cadence records planned until weekly/monthly reviews are performed with evidence. |
