...
| `SEIS-GOAL-002` | Establish SEIS Goal Tracking OS. | Goal Tracking OS | P1 high | active | Goal foundation | [`goal-tracking-system.md`](goal-tracking-system.md) | Create schema, milestone map, review cadence, product docs, and review report. |
...
| Goal Tracking OS | active | Schema and review cadence | No app implementation yet | [`goal-tracking-system.md`](goal-tracking-system.md) |
