...
| Shared styles | Browser-smoked | `apps/web/showcase/video-hero.css`, `docs/reviews/VIDEO_HERO_SHOWCASE_QA.md`, `npm run check:video-hero-browser-smoke` | No committed screenshot artifact or performance budget. | Attach generated screenshots to PR evidence and add performance budgets. |
