...
- 81 physical repository plugin sources, including 71 app-owned local plugin
  packages under
  `plugins/seis-core`;
- 4919 deterministic catalog-only capability slots generated from the SEIS
...
The 71 app-owned packages currently share the public Command Center release
...
All 71 app-owned plugin packages are public MIT-licensed source in the SEIS
...
boundary remains the 71-package public MIT repository set under
