...
- 71 physical repository plugin sources, including 61 app-owned local plugin
  packages under
  `plugins/seis-core`;
- 4929 deterministic catalog-only capability slots generated from the SEIS
...
The 61 app-owned packages currently share the public Command Center release
...
All 61 app-owned plugin packages are public MIT-licensed source in the SEIS
...
boundary remains the 61-package public MIT repository set under
