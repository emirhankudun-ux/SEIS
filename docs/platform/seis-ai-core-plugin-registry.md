...
- 72 physical repository plugin sources, including 62 app-owned local plugin
  packages under
  `plugins/seis-core`;
- 4928 deterministic catalog-only capability slots generated from the SEIS
...
The 62 app-owned packages currently share the public Command Center release
...
All 62 app-owned plugin packages are public MIT-licensed source in the SEIS
...
boundary remains the 62-package public MIT repository set under
