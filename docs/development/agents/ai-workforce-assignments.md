...
| Writer policy | Documented | `AGENTS.md`, `docs/development/agents/README.md`, this document | No runtime enforcement layer yet. | Keep Codex as the only writer for the next change package. |
| Credential boundary | Documented | `SECURITY.md`, `docs/ai/policy.md`, this document | No live provider use in this pass. | Keep provider keys server-side and out of prompts/logs. |
