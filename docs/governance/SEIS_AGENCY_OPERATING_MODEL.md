...
The five pods organize the thirteen existing Second Brain agent-role records.
They do not define or infer a mapping between the separate nine managed lanes
and thirteen role inventories. The machine-readable overlay is
