...
| Polyglot | `polyglot/` executable suite — 9 tested toolchains (Python · Rust · Go · C · C++ · Ruby · PHP · Java · Perl) via `scripts/polyglot-check.sh` + `polyglot.yml` CI; TS typings in `packages/seis-ai/types/` |
