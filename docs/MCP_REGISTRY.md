...
| `seis-focus-navigation-audit@seis-repo`                            | Static UI focus/navigation evidence inspector | Read-only; no browser, screen reader, source mutation, or release claim |
