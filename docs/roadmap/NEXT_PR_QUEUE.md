...
| Include | `docs/goals/*`, structured goal records, structured evidence records, local goal validator, Goal Tracking Center product docs, Command Center goals view, goal review report, backlog and index updates. |
