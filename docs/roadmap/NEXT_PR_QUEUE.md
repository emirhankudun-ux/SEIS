...
| Include | `docs/goals/*`, structured goal records, structured evidence records, structured execution records, structured review cadence records, structured performed review log records, structured planning horizon records, structured progress ledger records, structured objective coverage records, structured completion gate records, structured requirement matrix records, generated milestone timeline, generated Command Center view model, generated static Goal Tracking Center page, generated static Command Center shell, local goal validators, static page generators, Goal Tracking Center product docs, Command Center shell docs, Command Center goals view, goal review report, daily review report, weekly review report, monthly review report, objective audit, completion audit, requirement matrix audit, backlog and index updates. |
...
| Validation | `npm run check:goal-tracking`, `npm run check:goal-command-center-view`, `npm run check:goal-command-center-static`, `npm run check:command-center-shell`, `git diff --check`, `npm run seis:check`, `npm run check:foundation` with known blocker notes. |
