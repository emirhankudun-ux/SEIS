...
| Include | `docs/goals/*`, structured goal records, structured evidence records, structured execution records, structured review cadence records, structured planning horizon records, structured progress ledger records, structured objective coverage records, generated Command Center view model, generated static Goal Tracking Center page, local goal validators, static page generator, Goal Tracking Center product docs, Command Center goals view, goal review report, objective audit, backlog and index updates. |
