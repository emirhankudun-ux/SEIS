...
| `SEIS-BL-031` | P2 | Goal review cadence | Continue real weekly/monthly reviews using templates; weekly review for 2026-W25 is recorded, monthly remains planned. | Review records include date, scope, evidence, blockers, and validation output. |
