...
| [ai/conversation-nexus.md](ai/conversation-nexus.md) | Repo dışı OS-private session store, görünür-metin projeksiyonu, açık retention/export/delete kontrolleri, varsayılan kapalı MCP metadata ve onay kapılı harici import sınırı. |
