...
| [../scripts/create-seis-second-brain-public-reviewer-pack.mjs](../scripts/create-seis-second-brain-public-reviewer-pack.mjs) | Second Brain public reviewer pack generator for no-key GitHub review steps and blocked-action confirmations. |
| [../scripts/create-seis-public-demo-security-gate-report.mjs](../scripts/create-seis-public-demo-security-gate-report.mjs) | Redacted PR #104 public demo security gate artifact generator for current-tree clean status, full-history blocker categories, and owner approval requirements. |
| [../scripts/create-seis-security-owner-handoff.mjs](../scripts/create-seis-security-owner-handoff.mjs) | Security owner handoff generator for PR #104 owner decisions and agent assignments without raw finding values. |
...
| [../reports/seis-public-demo/second-brain-public-reviewer-pack-latest.md](../reports/seis-public-demo/second-brain-public-reviewer-pack-latest.md) | Latest Second Brain public reviewer pack for no-key GitHub review. |
| [../reports/seis-public-demo/security-gate-redacted-latest.md](../reports/seis-public-demo/security-gate-redacted-latest.md) | Latest redacted public demo security gate artifact for PR #104 security review. |
| [../reports/seis-public-demo/security-owner-handoff-latest.md](../reports/seis-public-demo/security-owner-handoff-latest.md) | Latest security owner handoff artifact for PR #104 owner decisions and agent assignments. |
| [security/PR127_SECURITY_REMEDIATION_PLAN.md](security/PR127_SECURITY_REMEDIATION_PLAN.md) | Plan-only PR #127 security remediation runbook for owner approval, rollback, and post-remediation validation. |
...
| [../scripts/create-seis-plugin-mcp-ten-year-continuity-map.mjs](../scripts/create-seis-plugin-mcp-ten-year-continuity-map.mjs) | SEIS Plugin/MCP Ten-Year Continuity Map artifact generator for supervised installed AI, connector, plugin, and MCP planning evidence. |
| [../scripts/create-seis-second-brain-public-reviewer-pack.mjs](../scripts/create-seis-second-brain-public-reviewer-pack.mjs) | Second Brain public reviewer pack generator for PR #104 no-key GitHub review evidence. |
| [../scripts/create-seis-public-demo-security-gate-report.mjs](../scripts/create-seis-public-demo-security-gate-report.mjs) | Redacted public demo security gate artifact generator for PR #104 review evidence. |
| [../scripts/create-seis-security-owner-handoff.mjs](../scripts/create-seis-security-owner-handoff.mjs) | Security owner handoff generator for PR #104 owner-decision evidence. |
...
| [../content/development/seis-plugin-mcp-ten-year-continuity-map.json](../content/development/seis-plugin-mcp-ten-year-continuity-map.json) | Machine-readable Plugin/MCP ten-year continuity contract checked by `npm run check:seis-plugin-mcp-ten-year-continuity-map`. |
| [platform/seis-plugin-mcp-ten-year-continuity-map.md](platform/seis-plugin-mcp-ten-year-continuity-map.md) | Platform documentation for the planning-only Plugin/MCP ten-year continuity map. |
| [../reports/seis-public-demo/plugin-mcp-ten-year-continuity-map-latest.json](../reports/seis-public-demo/plugin-mcp-ten-year-continuity-map-latest.json) | Machine-readable Plugin/MCP ten-year continuity artifact generated by `npm run report:seis-plugin-mcp-ten-year-continuity-map`. |
| [../reports/seis-public-demo/plugin-mcp-ten-year-continuity-map-latest.md](../reports/seis-public-demo/plugin-mcp-ten-year-continuity-map-latest.md) | Reader-facing Plugin/MCP ten-year continuity artifact generated by `npm run report:seis-plugin-mcp-ten-year-continuity-map`. |
| [../reports/seis-public-demo/second-brain-public-reviewer-pack-latest.json](../reports/seis-public-demo/second-brain-public-reviewer-pack-latest.json) | Machine-readable Second Brain public reviewer pack generated by `npm run report:seis-second-brain-public-reviewer-pack`. |
| [../reports/seis-public-demo/second-brain-public-reviewer-pack-latest.md](../reports/seis-public-demo/second-brain-public-reviewer-pack-latest.md) | Reader-facing Second Brain public reviewer pack generated by `npm run report:seis-second-brain-public-reviewer-pack`. |
| [../reports/seis-public-demo/security-gate-redacted-latest.json](../reports/seis-public-demo/security-gate-redacted-latest.json) | Machine-readable redacted security gate artifact generated by `npm run report:seis-public-demo-security-gate`. |
| [../reports/seis-public-demo/security-gate-redacted-latest.md](../reports/seis-public-demo/security-gate-redacted-latest.md) | Reader-facing redacted security gate artifact generated by `npm run report:seis-public-demo-security-gate`. |
| [../reports/seis-public-demo/security-owner-handoff-latest.json](../reports/seis-public-demo/security-owner-handoff-latest.json) | Machine-readable security owner handoff generated by `npm run report:seis-security-owner-handoff`. |
| [../reports/seis-public-demo/security-owner-handoff-latest.md](../reports/seis-public-demo/security-owner-handoff-latest.md) | Reader-facing security owner handoff generated by `npm run report:seis-security-owner-handoff`. |
| [../content/development/seis-public-demo-security-remediation-plan-pr127.json](../content/development/seis-public-demo-security-remediation-plan-pr127.json) | Machine-readable PR #127 security remediation plan checked by `npm run check:seis-second-brain-readiness-contracts`. |
