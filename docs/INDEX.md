...
| [../.github/workflows/seis-ssh-public-access.yml](../.github/workflows/seis-ssh-public-access.yml) | Dedicated GitHub Actions gate for public `SEIS-SSH` pull request checks without live SSH, config writes, endpoint migration, or secret exposure. |
| [../scripts/create-seis-ssh-public-review-bundle.mjs](../scripts/create-seis-ssh-public-review-bundle.mjs) | Read-only public review bundle generator for SEIS-SSH GitHub reviewers and installed AI assistants; writes `reports/seis-ssh-public-access/review-bundle-latest.md` without live SSH, GitHub auth, config writes, secret output, or server/port changes. |
| [../scripts/create-seis-ssh-ai-mcp-handoff-bundle.mjs](../scripts/create-seis-ssh-ai-mcp-handoff-bundle.mjs) | Read-only AI/MCP handoff generator for installed AI routes, MCP runtime, plugin lanes, connector boundaries, and `SEIS-SSH`; writes `reports/seis-ssh-public-access/ai-mcp-handoff-latest.md` without provider calls, MCP execution, GitHub auth, live SSH, config writes, secret output, or server/port changes. |
| [../scripts/create-seis-ssh-public-client-compatibility.mjs](../scripts/create-seis-ssh-public-client-compatibility.mjs) | Read-only client compatibility matrix generator for GitHub contributors, Terminal OpenSSH, ChatGPT/Codex picker, IDE users, installed AI/MCP/plugin reviewers, teams, mobile/new-device continuity, and maintainers; writes `reports/seis-ssh-public-access/client-compatibility-latest.md` without live SSH, provider calls, MCP execution, GitHub auth, config writes, secret output, or server/port changes. |
| [../scripts/create-seis-ssh-public-ai-plugin-review-matrix.mjs](../scripts/create-seis-ssh-public-ai-plugin-review-matrix.mjs) | Read-only AI/plugin review matrix for installed AI routes, MCP runtime surfaces, SEIS plugin lanes, and platform plugin evidence; writes `reports/seis-ssh-public-access/ai-plugin-review-latest.md` without provider calls, MCP mutation, connector auth, GitHub auth, live SSH, config writes, secret output, or server/port changes. |
...
| [../scripts/create-seis-ssh-public-first-run.mjs](../scripts/create-seis-ssh-public-first-run.mjs) | Read-only first-run guide generator for new GitHub contributors, setup-needed status, local tool readiness, and no-live-SSH public onboarding. |
| [../scripts/create-seis-ssh-public-troubleshooting-guide.mjs](../scripts/create-seis-ssh-public-troubleshooting-guide.mjs) | Read-only troubleshooting guide generator for missing alias, picker warning, billing blocker, local/LAN target, and live-ready claim boundaries. |
| [../scripts/create-seis-ssh-public-support-packet.mjs](../scripts/create-seis-ssh-public-support-packet.mjs) | Read-only GitHub issue support packet generator for sanitized SEIS-SSH command results, status labels, warning IDs, blocker IDs, and same-server/port evidence. |
| [../scripts/create-seis-ssh-public-github-quickstart.mjs](../scripts/create-seis-ssh-public-github-quickstart.mjs) | Read-only GitHub quickstart generator that turns first-run, troubleshooting, contributor doctor, and support-packet evidence into one safe public SEIS-SSH path. |
| [../scripts/create-seis-ssh-public-merge-readiness.mjs](../scripts/create-seis-ssh-public-merge-readiness.mjs) | Read-only merge readiness report generator that records GitHub ruleset blockers without merging, mutating GitHub, opening SSH, or changing server/port. |
| [../scripts/create-seis-ssh-public-github-policy-doctor.mjs](../scripts/create-seis-ssh-public-github-policy-doctor.mjs) | Read-only GitHub policy doctor for signed commit setup, required signatures, last-push approval, code owner review, and review-thread resolution without GitHub mutation. |
| [../scripts/create-seis-ssh-public-signing-guide.mjs](../scripts/create-seis-ssh-public-signing-guide.mjs) | Read-only public signing guide for verified signed commits and GitHub signing key setup without config writes, key printing, GitHub mutation, live SSH, or server/port changes. |
| [../scripts/check-seis-ssh-public-artifact-hygiene.mjs](../scripts/check-seis-ssh-public-artifact-hygiene.mjs) | Read-only temporary artifact hygiene gate for public SEIS-SSH JSON/Markdown reports before GitHub issue or PR attachment. |
