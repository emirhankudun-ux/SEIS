...
| [SEIS_CLOUD_AND_SSH.md](../SEIS_CLOUD_AND_SSH.md) | Cloud-and-SSH coordination index for public-safe remote/readiness planning. |
| [docs/cloud-ssh/SEIS_SSH_VISION.md](cloud-ssh/SEIS_SSH_VISION.md) | SEIS SSH concept vision for remote workflow planning. |
| [docs/cloud-ssh/SSH_SAFETY.md](cloud-ssh/SSH_SAFETY.md) | SSH safety command and handling rules for public docs. |
| [docs/cloud-ssh/REMOTE_WORKSPACE.md](cloud-ssh/REMOTE_WORKSPACE.md) | Safe remote workspace planning model and status conventions. |
| [docs/cloud-ssh/CODESPACES.md](cloud-ssh/CODESPACES.md) | Public-safe Codespaces onboarding and readiness notes. |
...
| [ai/seis-ai-fresh-clone-readiness.md](ai/seis-ai-fresh-clone-readiness.md) | Fresh-clone readiness contract for zero-key local-first repo verification and public-readiness boundary control. |
| [ai/seis-ai-public-readiness-program.md](ai/seis-ai-public-readiness-program.md) | AI public-readiness program contract and check composition for GitHub/AGI/fresh-clone readiness gates. |
| [ai/seis-retrieval-source-provenance.md](ai/seis-retrieval-source-provenance.md) | Retrieval source provenance manifest for future source-grounded retrieval without index builds, provider calls, private-data indexing, training, or AGI claims. |
| [ai/seis-retrieval-evaluation-fixtures.md](ai/seis-retrieval-evaluation-fixtures.md) | Retrieval evaluation fixture contract for golden queries, negative controls, and metric thresholds without index queries, provider calls, benchmark runs, or AGI claims. |
| [ai/seis-retrieval-evaluation-dry-run.md](ai/seis-retrieval-evaluation-dry-run.md) | Local-only retrieval evaluation dry-run for source-group coverage, negative-control policy, and safety invariants without answer generation, index queries, providers, benchmarks, training, or AGI claims. |
| [ai/seis-retrieval-citation-scorer-dry-run.md](ai/seis-retrieval-citation-scorer-dry-run.md) | Citation scorer dry-run harness for source URI/SHA coverage and citation rule checks without live scoring, answer generation, index queries, providers, benchmarks, training, or AGI claims. |
| [ai/seis-no-secret-answer-log-scan.md](ai/seis-no-secret-answer-log-scan.md) | Synthetic answer-log secret-pattern scanner for redacted samples without real log scanning, answer generation, index queries, providers, benchmarks, training, or AGI claims. |
| [ai/seis-redacted-answer-log-schema.md](ai/seis-redacted-answer-log-schema.md) | Metadata-only redacted answer-log schema for future logging without real log collection, prompt/answer body storage, providers, benchmarks, training, or AGI claims. |
| [ai/seis-security-blocker-diagnostic.md](ai/seis-security-blocker-diagnostic.md) | PR #100 security blocker diagnostic and approval handoff without secret value output, allowlist mutation, history rewrite, rotation, merge, release, or AGI/512B claim promotion. |
| [ai/seis-knowledge-retrieval-training.md](ai/seis-knowledge-retrieval-training.md) | Knowledge retrieval training contract for source-grounded SEIS knowledge without model downloads, provider calls, private-data indexing, or AGI claims. |
...
| [../scripts/check-seis-ai-fresh-clone-readiness.mjs](../scripts/check-seis-ai-fresh-clone-readiness.mjs) | Fresh-clone readiness validator for Local Demo boundaries, fresh-clone acceptance gates, and public-ready restrictions. |
| [../scripts/check-seis-ai-public-readiness.mjs](../scripts/check-seis-ai-public-readiness.mjs) | Composite AI public-readiness validator combining AGI, workforce, and fresh-clone gates. |
| [../scripts/check-seis-ai-public-readiness-program.mjs](../scripts/check-seis-ai-public-readiness-program.mjs) | AI public-readiness program validator for evidence and sequencing. |
| [../scripts/create-seis-ai-public-readiness-report.mjs](../scripts/create-seis-ai-public-readiness-report.mjs) | AI public-readiness evidence report writer for `../reports/seis-ai-public-readiness/` artifacts. |
| [../scripts/create-seis-retrieval-source-provenance-manifest.mjs](../scripts/create-seis-retrieval-source-provenance-manifest.mjs) | Retrieval source provenance manifest/report writer with allowlisted source groups, blocked private path classes, SHA-256 file records, and a redacted local secret-scan dry run. |
| [../scripts/create-seis-retrieval-evaluation-fixtures.mjs](../scripts/create-seis-retrieval-evaluation-fixtures.mjs) | Retrieval evaluation fixture/report writer for source-grounding, prompt-injection, private-data, staleness, and AGI/512B claim-boundary checks. |
| [../scripts/create-seis-retrieval-evaluation-dry-run.mjs](../scripts/create-seis-retrieval-evaluation-dry-run.mjs) | Retrieval evaluation dry-run writer for fixture/source-group coverage, negative-control policy checks, and no-answer/no-index/no-provider/no-benchmark invariants. |
| [../scripts/create-seis-retrieval-citation-scorer-dry-run.mjs](../scripts/create-seis-retrieval-citation-scorer-dry-run.mjs) | Citation scorer dry-run writer for source URI/SHA coverage, citation rules, and no-live-scoring boundaries. |
| [../scripts/create-seis-no-secret-answer-log-scan.mjs](../scripts/create-seis-no-secret-answer-log-scan.mjs) | Synthetic answer-log no-secret scanner/report writer for redacted local samples and no-real-log/no-answer-generation boundaries. |
| [../scripts/create-seis-redacted-answer-log-schema.mjs](../scripts/create-seis-redacted-answer-log-schema.mjs) | Redacted answer-log schema/report writer for metadata-only records, forbidden fields, redaction rules, and no-real-log boundaries. |
| [../scripts/create-seis-security-blocker-diagnostic.mjs](../scripts/create-seis-security-blocker-diagnostic.mjs) | Security blocker diagnostic/report writer for PR #100 GitLeaks blocker evidence and approval-gated remediation boundaries. |
| [../scripts/create-seis-knowledge-retrieval-training-contract.mjs](../scripts/create-seis-knowledge-retrieval-training-contract.mjs) | Knowledge retrieval training contract/report writer for source allowlists, private-data blocks, and no-AGI/no-fully-knowledgeable claim gates. |
...
| [../reports/seis-ai-public-readiness/latest.json](../reports/seis-ai-public-readiness/latest.json) | AI public-readiness evidence JSON snapshot generated by `npm run report:seis-ai-public-readiness`. |
| [../reports/seis-ai-public-readiness/latest.md](../reports/seis-ai-public-readiness/latest.md) | AI public-readiness evidence report generated by `npm run report:seis-ai-public-readiness`. |
| [../reports/seis-model-scaling/seis-retrieval-source-provenance-manifest.md](../reports/seis-model-scaling/seis-retrieval-source-provenance-manifest.md) | Retrieval source provenance reviewer report generated by `npm run report:seis-retrieval-source-provenance`. |
| [../reports/seis-model-scaling/seis-retrieval-evaluation-fixtures.md](../reports/seis-model-scaling/seis-retrieval-evaluation-fixtures.md) | Retrieval evaluation fixture reviewer report generated by `npm run report:seis-retrieval-evaluation-fixtures`. |
| [../reports/seis-model-scaling/seis-retrieval-evaluation-dry-run.md](../reports/seis-model-scaling/seis-retrieval-evaluation-dry-run.md) | Retrieval evaluation dry-run reviewer report generated by `npm run report:seis-retrieval-evaluation-dry-run`. |
| [../reports/seis-model-scaling/seis-retrieval-citation-scorer-dry-run.md](../reports/seis-model-scaling/seis-retrieval-citation-scorer-dry-run.md) | Retrieval citation scorer dry-run reviewer report generated by `npm run report:seis-retrieval-citation-scorer-dry-run`. |
| [../reports/seis-model-scaling/seis-no-secret-answer-log-scan.md](../reports/seis-model-scaling/seis-no-secret-answer-log-scan.md) | No-secret answer-log scanner reviewer report generated by `npm run report:seis-no-secret-answer-log-scan`. |
| [../reports/seis-model-scaling/seis-redacted-answer-log-schema.md](../reports/seis-model-scaling/seis-redacted-answer-log-schema.md) | Redacted answer-log schema reviewer report generated by `npm run report:seis-redacted-answer-log-schema`. |
| [../reports/seis-model-scaling/seis-security-blocker-diagnostic.md](../reports/seis-model-scaling/seis-security-blocker-diagnostic.md) | Security blocker diagnostic reviewer report generated by `npm run report:seis-security-blocker-diagnostic`. |
| [../reports/seis-model-scaling/seis-knowledge-retrieval-training-contract.md](../reports/seis-model-scaling/seis-knowledge-retrieval-training-contract.md) | Knowledge retrieval training reviewer report generated by `npm run report:seis-knowledge-retrieval-training`. |
