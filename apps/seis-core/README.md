...
- `packages/seis_platform_swift/Sources/SeisPlatformKit/SeisAIWorkforceAssignmentSnapshot.swift`: typed native projection of the ten-role workforce assignment registry, including launcher status, role duties, allowed outputs, denied actions, validation duty, and the Codex primary-writer policy.
