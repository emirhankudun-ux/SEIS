...
This is an optional public SEIS Repo selection bundle that groups exactly 9 retained application source capabilities. It is not a bulk installer and does not claim live provider, deployment, signing, or external write access.
...
- `skills/seis-application-bundle-02/SKILL.md` documents bounded selection and planning workflows.
