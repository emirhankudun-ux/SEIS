...
const BUNDLE = {
  ...
  "displayName": "SEIS Application: Product Design and Operations",
  "family": "application",
  "memberCount": 9,
  "members": [
    {
      "name": "seis-a11y-regression",
      "displayName": "SEIS A11y Regression",
      "sourcePath": "./plugins/seis-core/seis-a11y-regression",
      "category": "Design"
    },
    {
      "name": "seis-design-token-audit",
      "displayName": "SEIS Design Token Audit",
      "sourcePath": "./plugins/seis-core/seis-design-token-audit",
      "category": "Design"
    },
    {
      "name": "seis-dora-metrics",
      "displayName": "Seis Dora Metrics",
      "sourcePath": "./plugins/seis-core/seis-dora-metrics",
      "category": "Observability"
    },
    {
      "name": "seis-focus-navigation-audit",
      "displayName": "SEIS Focus Navigation Audit",
      "sourcePath": "./plugins/seis-core/seis-focus-navigation-audit",
      "category": "Design"
    },
    {
      "name": "seis-goal-integrity",
      "displayName": "SEIS Goal Integrity",
      "sourcePath": "./plugins/seis-core/seis-goal-integrity",
      "category": "Productivity"
    },
    {
      "name": "seis-maintainer-risk",
      "displayName": "Seis Maintainer Risk",
      "sourcePath": "./plugins/seis-core/seis-maintainer-risk",
      "category": "Governance"
    },
    {
      "name": "seis-project-manifest-audit",
      "displayName": "SEIS Project Manifest Audit",
      "sourcePath": "./plugins/seis-core/seis-project-manifest-audit",
      "category": "Productivity"
    },
    {
      "name": "seis-source-provenance",
      "displayName": "SEIS Source Provenance",
      "sourcePath": "./plugins/seis-core/seis-source-provenance",
      "category": "Productivity"
    },
    {
      "name": "seis-ui-state-contract-audit",
      "displayName": "SEIS UI State Contract Audit",
      "sourcePath": "./plugins/seis-core/seis-ui-state-contract-audit",
      "category": "Design"
    }
  ],
  "canonicalInstall": "seis-ai-agent@seis-repo",
  "statusTool": "seis_application_bundle_02_status",
  "membersTool": "seis_application_bundle_02_members",
  "planTool": "seis_application_bundle_02_plan"
};
...
const TOOLS = [
  ...
  { name: BUNDLE.membersTool, description: "List the bounded 9-member source capability map.", inputSchema: { type: "object", additionalProperties: false, properties: {} } },
