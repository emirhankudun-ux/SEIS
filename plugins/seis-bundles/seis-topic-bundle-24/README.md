...
This is an optional public SEIS Repo selection bundle that groups exactly 13 retained topic source capabilities. It is not a bulk installer and does not claim live provider, deployment, signing, or external write access.
...
- `skills/seis-topic-bundle-24/SKILL.md` documents bounded selection and planning workflows.
