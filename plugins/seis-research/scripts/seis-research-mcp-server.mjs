...
const LANE = {
  id: "seis-research",
  label: "SEIS Research",
  pluginName: "seis-research",
  skillPath: "skills/seis-research/SKILL.md",
  focus: "SEIS Research gives Codex a public SEIS plugin lane for official-source research, standards and version checks, source evaluation, product and architecture discovery, ecosystem analysis, and research-to-decision synthesis under SEIS-Agent governance.",
