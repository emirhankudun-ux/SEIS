...
description: Read-only Photography context and bounded repository evidence for SEIS work.
---

# Photography

Use this public SEIS topic skill when the task is specifically about **Photography** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Photography evidence, design, implementation planning, validation, or documentation.
