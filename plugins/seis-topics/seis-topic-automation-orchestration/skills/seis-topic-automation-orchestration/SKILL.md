...
description: Read-only Orchestration context and bounded repository evidence for SEIS work.
---

# Orchestration

Use this public SEIS topic skill when the task is specifically about **Orchestration** within the **Automation** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Orchestration evidence, design, implementation planning, validation, or documentation.
