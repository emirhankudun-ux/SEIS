...
description: Read-only Digital Twin context and bounded repository evidence for SEIS work.
---

# Digital Twin

Use this public SEIS topic skill when the task is specifically about **Digital Twin** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Digital Twin evidence, design, implementation planning, validation, or documentation.
