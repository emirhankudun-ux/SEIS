...
description: Read-only Chemistry context and bounded repository evidence for SEIS work.
---

# Chemistry

Use this public SEIS topic skill when the task is specifically about **Chemistry** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Chemistry evidence, design, implementation planning, validation, or documentation.
