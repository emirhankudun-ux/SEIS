...
description: Read-only SEIS Agent Runtime context and bounded repository evidence for SEIS work.
---

# SEIS Agent Runtime

Use this public SEIS topic skill when the task is specifically about **SEIS Agent Runtime** within the **SEIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as SEIS Agent Runtime evidence, design, implementation planning, validation, or documentation.
