...
description: Read-only Tracing context and bounded repository evidence for SEIS work.
---

# Tracing

Use this public SEIS topic skill when the task is specifically about **Tracing** within the **Cloud Computing** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Tracing evidence, design, implementation planning, validation, or documentation.
