...
description: Read-only Creative Coding context and bounded repository evidence for SEIS work.
---

# Creative Coding

Use this public SEIS topic skill when the task is specifically about **Creative Coding** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Creative Coding evidence, design, implementation planning, validation, or documentation.
