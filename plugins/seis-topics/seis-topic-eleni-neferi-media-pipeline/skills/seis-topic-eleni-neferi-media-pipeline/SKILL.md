...
description: Read-only Media Pipeline context and bounded repository evidence for SEIS work.
---

# Media Pipeline

Use this public SEIS topic skill when the task is specifically about **Media Pipeline** within the **ELENI-NEFERI** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Media Pipeline evidence, design, implementation planning, validation, or documentation.
