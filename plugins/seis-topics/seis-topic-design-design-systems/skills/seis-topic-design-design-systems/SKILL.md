...
description: Read-only Design Systems context and bounded repository evidence for SEIS work.
---

# Design Systems

Use this public SEIS topic skill when the task is specifically about **Design Systems** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Design Systems evidence, design, implementation planning, validation, or documentation.
