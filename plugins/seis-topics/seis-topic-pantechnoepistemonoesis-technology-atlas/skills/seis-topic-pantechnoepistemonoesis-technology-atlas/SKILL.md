...
description: Read-only Technology Atlas context and bounded repository evidence for SEIS work.
---

# Technology Atlas

Use this public SEIS topic skill when the task is specifically about **Technology Atlas** within the **PANTECHNOEPISTEMONOESIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Technology Atlas evidence, design, implementation planning, validation, or documentation.
