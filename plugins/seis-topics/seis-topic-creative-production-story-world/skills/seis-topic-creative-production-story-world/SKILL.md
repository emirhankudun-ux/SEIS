...
description: Read-only Story World context and bounded repository evidence for SEIS work.
---

# Story World

Use this public SEIS topic skill when the task is specifically about **Story World** within the **Creative Production** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Story World evidence, design, implementation planning, validation, or documentation.
