...
description: Read-only Plugin Registry context and bounded repository evidence for SEIS work.
---

# Plugin Registry

Use this public SEIS topic skill when the task is specifically about **Plugin Registry** within the **Automation** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Plugin Registry evidence, design, implementation planning, validation, or documentation.
