...
description: Read-only Data Engineering context and bounded repository evidence for SEIS work.
---

# Data Engineering

Use this public SEIS topic skill when the task is specifically about **Data Engineering** within the **Data** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Data Engineering evidence, design, implementation planning, validation, or documentation.
