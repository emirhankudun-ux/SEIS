...
description: Read-only Engineering Civilization context and bounded repository evidence for SEIS work.
---

# Engineering Civilization

Use this public SEIS topic skill when the task is specifically about **Engineering Civilization** within the **PANTECHNOEPISTEMONOESIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Engineering Civilization evidence, design, implementation planning, validation, or documentation.
