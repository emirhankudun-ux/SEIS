...
description: Read-only Quality Assurance context and bounded repository evidence for SEIS work.
---

# Quality Assurance

Use this public SEIS topic skill when the task is specifically about **Quality Assurance** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Quality Assurance evidence, design, implementation planning, validation, or documentation.
