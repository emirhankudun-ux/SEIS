...
description: Read-only SEIS Repository Intelligence context and bounded repository evidence for SEIS work.
---

# SEIS Repository Intelligence

Use this public SEIS topic skill when the task is specifically about **SEIS Repository Intelligence** within the **SEIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as SEIS Repository Intelligence evidence, design, implementation planning, validation, or documentation.
