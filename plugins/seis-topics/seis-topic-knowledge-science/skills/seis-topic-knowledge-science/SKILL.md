...
description: Read-only Science context and bounded repository evidence for SEIS work.
---

# Science

Use this public SEIS topic skill when the task is specifically about **Science** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Science evidence, design, implementation planning, validation, or documentation.
