...
description: Read-only Identity Bible context and bounded repository evidence for SEIS work.
---

# Identity Bible

Use this public SEIS topic skill when the task is specifically about **Identity Bible** within the **ELENI-NEFERI** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Identity Bible evidence, design, implementation planning, validation, or documentation.
