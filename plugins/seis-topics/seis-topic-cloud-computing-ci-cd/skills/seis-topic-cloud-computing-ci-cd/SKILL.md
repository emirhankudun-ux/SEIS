...
description: Read-only CI/CD context and bounded repository evidence for SEIS work.
---

# CI/CD

Use this public SEIS topic skill when the task is specifically about **CI/CD** within the **Cloud Computing** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as CI/CD evidence, design, implementation planning, validation, or documentation.
