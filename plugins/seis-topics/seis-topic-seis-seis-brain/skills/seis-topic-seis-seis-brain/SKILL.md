...
description: Read-only SEIS Brain context and bounded repository evidence for SEIS work.
---

# SEIS Brain

Use this public SEIS topic skill when the task is specifically about **SEIS Brain** within the **SEIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as SEIS Brain evidence, design, implementation planning, validation, or documentation.
