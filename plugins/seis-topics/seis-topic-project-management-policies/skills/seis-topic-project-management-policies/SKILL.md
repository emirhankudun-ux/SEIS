...
description: Read-only Policies context and bounded repository evidence for SEIS work.
---

# Policies

Use this public SEIS topic skill when the task is specifically about **Policies** within the **Project Management** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Policies evidence, design, implementation planning, validation, or documentation.
