...
description: Read-only Audit context and bounded repository evidence for SEIS work.
---

# Audit

Use this public SEIS topic skill when the task is specifically about **Audit** within the **Project Management** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Audit evidence, design, implementation planning, validation, or documentation.
