...
description: Read-only Skills context and bounded repository evidence for SEIS work.
---

# Skills

Use this public SEIS topic skill when the task is specifically about **Skills** within the **Automation** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Skills evidence, design, implementation planning, validation, or documentation.
