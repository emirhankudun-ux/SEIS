...
description: Read-only Shaders context and bounded repository evidence for SEIS work.
---

# Shaders

Use this public SEIS topic skill when the task is specifically about **Shaders** within the **Graphics** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Shaders evidence, design, implementation planning, validation, or documentation.
