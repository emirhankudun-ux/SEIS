...
description: Read-only Business Intelligence context and bounded repository evidence for SEIS work.
---

# Business Intelligence

Use this public SEIS topic skill when the task is specifically about **Business Intelligence** within the **Data** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Business Intelligence evidence, design, implementation planning, validation, or documentation.
