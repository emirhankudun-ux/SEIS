...
description: Read-only Asset Universe context and bounded repository evidence for SEIS work.
---

# Asset Universe

Use this public SEIS topic skill when the task is specifically about **Asset Universe** within the **ELENI-NEFERI** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Asset Universe evidence, design, implementation planning, validation, or documentation.
