...
- `skills/seis-topic-eleni-neferi-visual-identity/SKILL.md` defines the topic workflow.
- `assets/topic-profile.json` records source, audience, license, maturity, and permissions.
- `scripts/seis-topic-eleni-neferi-visual-identity-mcp-server.mjs` exposes status and bounded report tools.
...
```bash
node plugins/seis-topics/seis-topic-eleni-neferi-visual-identity/scripts/seis-topic-eleni-neferi-visual-identity-mcp-server.mjs --status
