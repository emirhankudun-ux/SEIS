...
description: Read-only Zero Trust context and bounded repository evidence for SEIS work.
---

# Zero Trust

Use this public SEIS topic skill when the task is specifically about **Zero Trust** within the **Cybersecurity** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Zero Trust evidence, design, implementation planning, validation, or documentation.
