...
description: Read-only Domain-Driven Design context and bounded repository evidence for SEIS work.
---

# Domain-Driven Design

Use this public SEIS topic skill when the task is specifically about **Domain-Driven Design** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Domain-Driven Design evidence, design, implementation planning, validation, or documentation.
