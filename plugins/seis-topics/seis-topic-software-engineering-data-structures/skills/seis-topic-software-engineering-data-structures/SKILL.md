...
description: Read-only Data Structures context and bounded repository evidence for SEIS work.
---

# Data Structures

Use this public SEIS topic skill when the task is specifically about **Data Structures** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Data Structures evidence, design, implementation planning, validation, or documentation.
