...
description: Read-only Multimodal AI context and bounded repository evidence for SEIS work.
---

# Multimodal AI

Use this public SEIS topic skill when the task is specifically about **Multimodal AI** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Multimodal AI evidence, design, implementation planning, validation, or documentation.
