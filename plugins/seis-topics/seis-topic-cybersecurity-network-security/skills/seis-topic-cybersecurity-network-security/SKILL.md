...
description: Read-only Network Security context and bounded repository evidence for SEIS work.
---

# Network Security

Use this public SEIS topic skill when the task is specifically about **Network Security** within the **Cybersecurity** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Network Security evidence, design, implementation planning, validation, or documentation.
