...
This is an objective-derived public SEIS topic package for the **PANTECHNOEPISTEMONOESIS** family. It is published directly from the SEIS repository marketplace as `seis-topic-pantechnoepistemonoesis@seis-repo`.
