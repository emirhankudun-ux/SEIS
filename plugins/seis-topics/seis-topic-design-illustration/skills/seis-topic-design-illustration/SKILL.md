...
description: Read-only Illustration context and bounded repository evidence for SEIS work.
---

# Illustration

Use this public SEIS topic skill when the task is specifically about **Illustration** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Illustration evidence, design, implementation planning, validation, or documentation.
