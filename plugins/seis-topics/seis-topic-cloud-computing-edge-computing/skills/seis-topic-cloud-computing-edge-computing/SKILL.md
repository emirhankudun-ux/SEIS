...
description: Read-only Edge Computing context and bounded repository evidence for SEIS work.
---

# Edge Computing

Use this public SEIS topic skill when the task is specifically about **Edge Computing** within the **Cloud Computing** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Edge Computing evidence, design, implementation planning, validation, or documentation.
