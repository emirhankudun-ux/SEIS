...
description: Read-only SQL context and bounded repository evidence for SEIS work.
---

# SQL

Use this public SEIS topic skill when the task is specifically about **SQL** within the **Data** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as SQL evidence, design, implementation planning, validation, or documentation.
