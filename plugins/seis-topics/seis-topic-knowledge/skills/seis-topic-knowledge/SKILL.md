...
description: Read-only Knowledge context and bounded repository evidence for SEIS work.
---

# Knowledge

Use this public SEIS topic skill when the task is specifically about **Knowledge** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Knowledge evidence, design, implementation planning, validation, or documentation.
