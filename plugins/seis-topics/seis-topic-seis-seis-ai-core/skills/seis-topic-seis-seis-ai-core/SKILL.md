...
description: Read-only SEIS AI Core context and bounded repository evidence for SEIS work.
---

# SEIS AI Core

Use this public SEIS topic skill when the task is specifically about **SEIS AI Core** within the **SEIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as SEIS AI Core evidence, design, implementation planning, validation, or documentation.
