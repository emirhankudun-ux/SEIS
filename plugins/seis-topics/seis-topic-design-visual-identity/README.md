...
This is an objective-derived public SEIS topic package for the **Design** family. It is published directly from the SEIS repository marketplace as `seis-topic-design-visual-identity@seis-repo`.
