...
description: Read-only Analytics context and bounded repository evidence for SEIS work.
---

# Analytics

Use this public SEIS topic skill when the task is specifically about **Analytics** within the **Data** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Analytics evidence, design, implementation planning, validation, or documentation.
