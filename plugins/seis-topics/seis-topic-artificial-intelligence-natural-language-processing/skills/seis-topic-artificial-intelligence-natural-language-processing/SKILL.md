...
description: Read-only Natural Language Processing context and bounded repository evidence for SEIS work.
---

# Natural Language Processing

Use this public SEIS topic skill when the task is specifically about **Natural Language Processing** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Natural Language Processing evidence, design, implementation planning, validation, or documentation.
