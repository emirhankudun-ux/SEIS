...
description: Read-only Data Quality context and bounded repository evidence for SEIS work.
---

# Data Quality

Use this public SEIS topic skill when the task is specifically about **Data Quality** within the **Data** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Data Quality evidence, design, implementation planning, validation, or documentation.
