...
description: Read-only Creative Engineering context and bounded repository evidence for SEIS work.
---

# Creative Engineering

Use this public SEIS topic skill when the task is specifically about **Creative Engineering** within the **Creative Production** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Creative Engineering evidence, design, implementation planning, validation, or documentation.
