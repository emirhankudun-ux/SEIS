...
description: Read-only Reasoning Models context and bounded repository evidence for SEIS work.
---

# Reasoning Models

Use this public SEIS topic skill when the task is specifically about **Reasoning Models** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Reasoning Models evidence, design, implementation planning, validation, or documentation.
