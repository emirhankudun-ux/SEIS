...
description: Read-only Knowledge Graph context and bounded repository evidence for SEIS work.
---

# Knowledge Graph

Use this public SEIS topic skill when the task is specifically about **Knowledge Graph** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Knowledge Graph evidence, design, implementation planning, validation, or documentation.
