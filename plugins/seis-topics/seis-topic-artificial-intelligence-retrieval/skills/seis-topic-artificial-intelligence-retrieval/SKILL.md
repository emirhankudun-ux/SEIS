...
description: Read-only Retrieval context and bounded repository evidence for SEIS work.
---

# Retrieval

Use this public SEIS topic skill when the task is specifically about **Retrieval** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Retrieval evidence, design, implementation planning, validation, or documentation.
