...
description: Read-only Branding context and bounded repository evidence for SEIS work.
---

# Branding

Use this public SEIS topic skill when the task is specifically about **Branding** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Branding evidence, design, implementation planning, validation, or documentation.
