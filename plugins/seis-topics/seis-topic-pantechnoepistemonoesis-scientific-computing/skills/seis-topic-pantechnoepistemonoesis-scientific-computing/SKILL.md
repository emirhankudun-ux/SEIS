...
description: Read-only Scientific Computing context and bounded repository evidence for SEIS work.
---

# Scientific Computing

Use this public SEIS topic skill when the task is specifically about **Scientific Computing** within the **PANTECHNOEPISTEMONOESIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Scientific Computing evidence, design, implementation planning, validation, or documentation.
