...
description: Read-only Editorial Design context and bounded repository evidence for SEIS work.
---

# Editorial Design

Use this public SEIS topic skill when the task is specifically about **Editorial Design** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Editorial Design evidence, design, implementation planning, validation, or documentation.
