...
description: Read-only Lifestyle context and bounded repository evidence for SEIS work.
---

# Lifestyle

Use this public SEIS topic skill when the task is specifically about **Lifestyle** within the **ELENI-NEFERI** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Lifestyle evidence, design, implementation planning, validation, or documentation.
