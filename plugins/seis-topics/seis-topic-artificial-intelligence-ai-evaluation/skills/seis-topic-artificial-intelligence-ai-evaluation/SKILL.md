...
description: Read-only AI Evaluation context and bounded repository evidence for SEIS work.
---

# AI Evaluation

Use this public SEIS topic skill when the task is specifically about **AI Evaluation** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as AI Evaluation evidence, design, implementation planning, validation, or documentation.
