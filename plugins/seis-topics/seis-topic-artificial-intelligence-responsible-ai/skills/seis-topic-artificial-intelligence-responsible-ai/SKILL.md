...
description: Read-only Responsible AI context and bounded repository evidence for SEIS work.
---

# Responsible AI

Use this public SEIS topic skill when the task is specifically about **Responsible AI** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Responsible AI evidence, design, implementation planning, validation, or documentation.
