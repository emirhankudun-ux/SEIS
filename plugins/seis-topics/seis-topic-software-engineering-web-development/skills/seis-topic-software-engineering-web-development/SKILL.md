...
description: Read-only Web Development context and bounded repository evidence for SEIS work.
---

# Web Development

Use this public SEIS topic skill when the task is specifically about **Web Development** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Web Development evidence, design, implementation planning, validation, or documentation.
