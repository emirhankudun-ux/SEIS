...
description: Read-only iPadOS context and bounded repository evidence for SEIS work.
---

# iPadOS

Use this public SEIS topic skill when the task is specifically about **iPadOS** within the **Desktop** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as iPadOS evidence, design, implementation planning, validation, or documentation.
