...
- `scripts/seis-topic-automation-command-center-mcp-server.mjs` exposes status and bounded report tools.
...
```bash
node plugins/seis-topics/seis-topic-automation-command-center/scripts/seis-topic-automation-command-center-mcp-server.mjs --status
