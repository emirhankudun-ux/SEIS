...
description: Read-only Linux context and bounded repository evidence for SEIS work.
---

# Linux

Use this public SEIS topic skill when the task is specifically about **Linux** within the **Desktop** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Linux evidence, design, implementation planning, validation, or documentation.
