...
description: Read-only Artificial Intelligence context and bounded repository evidence for SEIS work.
---

# Artificial Intelligence

Use this public SEIS topic skill when the task is specifically about **Artificial Intelligence** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Artificial Intelligence evidence, design, implementation planning, validation, or documentation.
