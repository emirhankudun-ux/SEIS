...
description: Read-only Containers context and bounded repository evidence for SEIS work.
---

# Containers

Use this public SEIS topic skill when the task is specifically about **Containers** within the **Cloud Computing** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Containers evidence, design, implementation planning, validation, or documentation.
