...
description: Read-only Prompt Engineering context and bounded repository evidence for SEIS work.
---

# Prompt Engineering

Use this public SEIS topic skill when the task is specifically about **Prompt Engineering** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Prompt Engineering evidence, design, implementation planning, validation, or documentation.
