...
description: Read-only Research context and bounded repository evidence for SEIS work.
---

# Research

Use this public SEIS topic skill when the task is specifically about **Research** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Research evidence, design, implementation planning, validation, or documentation.
