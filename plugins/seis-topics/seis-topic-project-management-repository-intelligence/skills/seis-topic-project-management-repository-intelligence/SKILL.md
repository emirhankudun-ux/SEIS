...
description: Read-only Repository Intelligence context and bounded repository evidence for SEIS work.
---

# Repository Intelligence

Use this public SEIS topic skill when the task is specifically about **Repository Intelligence** within the **Project Management** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Repository Intelligence evidence, design, implementation planning, validation, or documentation.
