...
description: Read-only Deep Learning context and bounded repository evidence for SEIS work.
---

# Deep Learning

Use this public SEIS topic skill when the task is specifically about **Deep Learning** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Deep Learning evidence, design, implementation planning, validation, or documentation.
