...
description: Read-only Repository Management context and bounded repository evidence for SEIS work.
---

# Repository Management

Use this public SEIS topic skill when the task is specifically about **Repository Management** within the **Project Management** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Repository Management evidence, design, implementation planning, validation, or documentation.
