...
description: Read-only Speech AI context and bounded repository evidence for SEIS work.
---

# Speech AI

Use this public SEIS topic skill when the task is specifically about **Speech AI** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Speech AI evidence, design, implementation planning, validation, or documentation.
