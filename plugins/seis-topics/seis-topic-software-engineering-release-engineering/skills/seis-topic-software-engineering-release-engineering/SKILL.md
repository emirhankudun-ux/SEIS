...
description: Read-only Release Engineering context and bounded repository evidence for SEIS work.
---

# Release Engineering

Use this public SEIS topic skill when the task is specifically about **Release Engineering** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Release Engineering evidence, design, implementation planning, validation, or documentation.
