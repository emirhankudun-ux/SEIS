...
description: Read-only Visual Design context and bounded repository evidence for SEIS work.
---

# Visual Design

Use this public SEIS topic skill when the task is specifically about **Visual Design** within the **Design** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Visual Design evidence, design, implementation planning, validation, or documentation.
