...
description: Read-only Ray Tracing context and bounded repository evidence for SEIS work.
---

# Ray Tracing

Use this public SEIS topic skill when the task is specifically about **Ray Tracing** within the **Graphics** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Ray Tracing evidence, design, implementation planning, validation, or documentation.
