...
description: Read-only ABAC context and bounded repository evidence for SEIS work.
---

# ABAC

Use this public SEIS topic skill when the task is specifically about **ABAC** within the **Cybersecurity** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as ABAC evidence, design, implementation planning, validation, or documentation.
