...
description: Read-only Encryption context and bounded repository evidence for SEIS work.
---

# Encryption

Use this public SEIS topic skill when the task is specifically about **Encryption** within the **Cybersecurity** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Encryption evidence, design, implementation planning, validation, or documentation.
