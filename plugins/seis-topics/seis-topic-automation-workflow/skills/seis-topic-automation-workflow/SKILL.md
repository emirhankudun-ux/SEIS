...
description: Read-only Workflow context and bounded repository evidence for SEIS work.
---

# Workflow

Use this public SEIS topic skill when the task is specifically about **Workflow** within the **Automation** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Workflow evidence, design, implementation planning, validation, or documentation.
