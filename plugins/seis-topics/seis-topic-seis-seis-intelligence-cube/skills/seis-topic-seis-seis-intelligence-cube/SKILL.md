...
description: Read-only SEIS Intelligence Cube context and bounded repository evidence for SEIS work.
---

# SEIS Intelligence Cube

Use this public SEIS topic skill when the task is specifically about **SEIS Intelligence Cube** within the **SEIS** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as SEIS Intelligence Cube evidence, design, implementation planning, validation, or documentation.
