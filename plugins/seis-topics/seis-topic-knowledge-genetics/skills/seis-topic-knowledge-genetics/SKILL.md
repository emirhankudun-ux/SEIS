...
description: Read-only Genetics context and bounded repository evidence for SEIS work.
---

# Genetics

Use this public SEIS topic skill when the task is specifically about **Genetics** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Genetics evidence, design, implementation planning, validation, or documentation.
