...
description: Read-only TUI context and bounded repository evidence for SEIS work.
---

# TUI

Use this public SEIS topic skill when the task is specifically about **TUI** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as TUI evidence, design, implementation planning, validation, or documentation.
