...
description: Read-only Computer Vision context and bounded repository evidence for SEIS work.
---

# Computer Vision

Use this public SEIS topic skill when the task is specifically about **Computer Vision** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Computer Vision evidence, design, implementation planning, validation, or documentation.
