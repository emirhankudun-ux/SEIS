...
description: Read-only Build Systems context and bounded repository evidence for SEIS work.
---

# Build Systems

Use this public SEIS topic skill when the task is specifically about **Build Systems** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Build Systems evidence, design, implementation planning, validation, or documentation.
