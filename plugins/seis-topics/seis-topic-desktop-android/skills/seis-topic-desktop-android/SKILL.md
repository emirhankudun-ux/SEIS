...
description: Read-only Android context and bounded repository evidence for SEIS work.
---

# Android

Use this public SEIS topic skill when the task is specifically about **Android** within the **Desktop** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Android evidence, design, implementation planning, validation, or documentation.
