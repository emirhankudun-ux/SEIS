...
description: Read-only Profiling context and bounded repository evidence for SEIS work.
---

# Profiling

Use this public SEIS topic skill when the task is specifically about **Profiling** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Profiling evidence, design, implementation planning, validation, or documentation.
