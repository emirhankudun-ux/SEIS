...
description: Read-only Small Language Models context and bounded repository evidence for SEIS work.
---

# Small Language Models

Use this public SEIS topic skill when the task is specifically about **Small Language Models** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Small Language Models evidence, design, implementation planning, validation, or documentation.
