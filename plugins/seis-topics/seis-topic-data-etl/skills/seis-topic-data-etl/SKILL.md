...
description: Read-only ETL context and bounded repository evidence for SEIS work.
---

# ETL

Use this public SEIS topic skill when the task is specifically about **ETL** within the **Data** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as ETL evidence, design, implementation planning, validation, or documentation.
