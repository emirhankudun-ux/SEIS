...
description: Read-only Privacy context and bounded repository evidence for SEIS work.
---

# Privacy

Use this public SEIS topic skill when the task is specifically about **Privacy** within the **Cybersecurity** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Privacy evidence, design, implementation planning, validation, or documentation.
