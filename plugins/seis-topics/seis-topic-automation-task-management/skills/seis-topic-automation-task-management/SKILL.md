...
description: Read-only Task Management context and bounded repository evidence for SEIS work.
---

# Task Management

Use this public SEIS topic skill when the task is specifically about **Task Management** within the **Automation** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Task Management evidence, design, implementation planning, validation, or documentation.
