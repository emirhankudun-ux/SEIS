...
description: Read-only Modular Monolith context and bounded repository evidence for SEIS work.
---

# Modular Monolith

Use this public SEIS topic skill when the task is specifically about **Modular Monolith** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Modular Monolith evidence, design, implementation planning, validation, or documentation.
