...
description: Read-only Compilers context and bounded repository evidence for SEIS work.
---

# Compilers

Use this public SEIS topic skill when the task is specifically about **Compilers** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Compilers evidence, design, implementation planning, validation, or documentation.
