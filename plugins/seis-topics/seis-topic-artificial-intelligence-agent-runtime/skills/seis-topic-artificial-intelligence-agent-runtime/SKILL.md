...
description: Read-only Agent Runtime context and bounded repository evidence for SEIS work.
---

# Agent Runtime

Use this public SEIS topic skill when the task is specifically about **Agent Runtime** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Agent Runtime evidence, design, implementation planning, validation, or documentation.
