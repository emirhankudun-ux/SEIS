...
description: Read-only Authorization context and bounded repository evidence for SEIS work.
---

# Authorization

Use this public SEIS topic skill when the task is specifically about **Authorization** within the **Cybersecurity** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Authorization evidence, design, implementation planning, validation, or documentation.
