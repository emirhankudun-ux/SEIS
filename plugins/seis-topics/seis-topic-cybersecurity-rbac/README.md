...
- `scripts/seis-topic-cybersecurity-rbac-mcp-server.mjs` exposes status and bounded report tools.
...
```bash
node plugins/seis-topics/seis-topic-cybersecurity-rbac/scripts/seis-topic-cybersecurity-rbac-mcp-server.mjs --status
