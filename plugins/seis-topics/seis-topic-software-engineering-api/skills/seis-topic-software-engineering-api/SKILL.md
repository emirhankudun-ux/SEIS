...
description: Read-only API context and bounded repository evidence for SEIS work.
---

# API

Use this public SEIS topic skill when the task is specifically about **API** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as API evidence, design, implementation planning, validation, or documentation.
