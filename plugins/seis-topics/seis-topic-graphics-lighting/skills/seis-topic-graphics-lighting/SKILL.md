...
description: Read-only Lighting context and bounded repository evidence for SEIS work.
---

# Lighting

Use this public SEIS topic skill when the task is specifically about **Lighting** within the **Graphics** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Lighting evidence, design, implementation planning, validation, or documentation.
