...
description: Read-only Programming Languages context and bounded repository evidence for SEIS work.
---

# Programming Languages

Use this public SEIS topic skill when the task is specifically about **Programming Languages** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Programming Languages evidence, design, implementation planning, validation, or documentation.
