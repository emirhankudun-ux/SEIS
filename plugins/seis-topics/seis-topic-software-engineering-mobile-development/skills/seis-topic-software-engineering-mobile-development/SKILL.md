...
description: Read-only Mobile Development context and bounded repository evidence for SEIS work.
---

# Mobile Development

Use this public SEIS topic skill when the task is specifically about **Mobile Development** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Mobile Development evidence, design, implementation planning, validation, or documentation.
