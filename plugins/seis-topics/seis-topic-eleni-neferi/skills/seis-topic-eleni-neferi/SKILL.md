...
description: Read-only ELENI-NEFERI context and bounded repository evidence for SEIS work.
---

# ELENI-NEFERI

Use this public SEIS topic skill when the task is specifically about **ELENI-NEFERI** within the **ELENI-NEFERI** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as ELENI-NEFERI evidence, design, implementation planning, validation, or documentation.
