...
description: Read-only Architecture Governance context and bounded repository evidence for SEIS work.
---

# Architecture Governance

Use this public SEIS topic skill when the task is specifically about **Architecture Governance** within the **Project Management** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Architecture Governance evidence, design, implementation planning, validation, or documentation.
