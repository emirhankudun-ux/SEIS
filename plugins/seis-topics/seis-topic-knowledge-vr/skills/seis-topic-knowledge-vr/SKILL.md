...
description: Read-only VR context and bounded repository evidence for SEIS work.
---

# VR

Use this public SEIS topic skill when the task is specifically about **VR** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as VR evidence, design, implementation planning, validation, or documentation.
