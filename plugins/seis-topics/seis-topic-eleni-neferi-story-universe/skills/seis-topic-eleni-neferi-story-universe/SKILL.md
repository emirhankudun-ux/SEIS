...
description: Read-only Story Universe context and bounded repository evidence for SEIS work.
---

# Story Universe

Use this public SEIS topic skill when the task is specifically about **Story Universe** within the **ELENI-NEFERI** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Story Universe evidence, design, implementation planning, validation, or documentation.
