...
description: Read-only Templates context and bounded repository evidence for SEIS work.
---

# Templates

Use this public SEIS topic skill when the task is specifically about **Templates** within the **Automation** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Templates evidence, design, implementation planning, validation, or documentation.
