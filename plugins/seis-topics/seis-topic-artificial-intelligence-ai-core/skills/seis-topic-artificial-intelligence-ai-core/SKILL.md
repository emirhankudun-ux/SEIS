...
description: Read-only AI Core context and bounded repository evidence for SEIS work.
---

# AI Core

Use this public SEIS topic skill when the task is specifically about **AI Core** within the **Artificial Intelligence** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as AI Core evidence, design, implementation planning, validation, or documentation.
