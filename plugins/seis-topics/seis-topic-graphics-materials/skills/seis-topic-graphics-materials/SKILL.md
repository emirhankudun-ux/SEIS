...
description: Read-only Materials context and bounded repository evidence for SEIS work.
---

# Materials

Use this public SEIS topic skill when the task is specifically about **Materials** within the **Graphics** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Materials evidence, design, implementation planning, validation, or documentation.
