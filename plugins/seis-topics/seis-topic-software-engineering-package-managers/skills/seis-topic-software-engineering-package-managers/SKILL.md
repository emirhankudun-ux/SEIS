...
description: Read-only Package Managers context and bounded repository evidence for SEIS work.
---

# Package Managers

Use this public SEIS topic skill when the task is specifically about **Package Managers** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Package Managers evidence, design, implementation planning, validation, or documentation.
