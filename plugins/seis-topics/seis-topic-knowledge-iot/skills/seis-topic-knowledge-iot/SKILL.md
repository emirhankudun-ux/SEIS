...
description: Read-only IoT context and bounded repository evidence for SEIS work.
---

# IoT

Use this public SEIS topic skill when the task is specifically about **IoT** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as IoT evidence, design, implementation planning, validation, or documentation.
