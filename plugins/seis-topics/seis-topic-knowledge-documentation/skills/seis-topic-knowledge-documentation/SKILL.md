...
description: Read-only Documentation context and bounded repository evidence for SEIS work.
---

# Documentation

Use this public SEIS topic skill when the task is specifically about **Documentation** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Documentation evidence, design, implementation planning, validation, or documentation.
