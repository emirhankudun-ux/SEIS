...
description: Read-only Operating Systems context and bounded repository evidence for SEIS work.
---

# Operating Systems

Use this public SEIS topic skill when the task is specifically about **Operating Systems** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Operating Systems evidence, design, implementation planning, validation, or documentation.
