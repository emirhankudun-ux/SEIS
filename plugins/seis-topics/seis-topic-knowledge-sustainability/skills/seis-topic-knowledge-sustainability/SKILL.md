...
description: Read-only Sustainability context and bounded repository evidence for SEIS work.
---

# Sustainability

Use this public SEIS topic skill when the task is specifically about **Sustainability** within the **Knowledge** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Sustainability evidence, design, implementation planning, validation, or documentation.
