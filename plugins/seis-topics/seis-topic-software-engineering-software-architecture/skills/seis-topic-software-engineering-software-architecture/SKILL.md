...
description: Read-only Software Architecture context and bounded repository evidence for SEIS work.
---

# Software Architecture

Use this public SEIS topic skill when the task is specifically about **Software Architecture** within the **Software Engineering** family.

## Workflow

1. Read the repository instructions, project manifest, active goal, and nearby architecture docs.
2. Classify the request as Software Architecture evidence, design, implementation planning, validation, or documentation.
