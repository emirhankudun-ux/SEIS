...
const LANE = {
  id: "seis-product",
  label: "SEIS Product",
  pluginName: "seis-product",
  skillPath: "skills/seis-product/SKILL.md",
  focus: "SEIS Product gives Codex a public SEIS plugin lane for product requirements, roadmap slices, acceptance criteria, UX outcomes, launch readiness, open-source positioning, prioritization, and validation-backed delivery plans under SEIS-Agent governance.",
