...
const LANE = {
  id: "seis-security",
  label: "SEIS Security",
  pluginName: "seis-security",
  skillPath: "skills/seis-security/SKILL.md",
  focus: "SEIS Security gives Codex a public SEIS plugin lane for threat modeling, secret-safety review, dependency and permission risk, CI/security gates, cloud access safety, SSH/VPN hardening, and release-blocking security checks under SEIS-Agent governance.",
