...
test("reconciles Wave 3 implementation steps through a public-only feature-branch checkpoint", () => {
  ...
  assert.equal(checkpoint.publicDistribution.marketplaceName, "seis-repo");
  assert.equal(checkpoint.publicDistribution.applicationPluginCount, 73);
  assert.equal(checkpoint.publicDistribution.marketplaceCardCount, 379);
