...
`reports/evals/ai-core-panel-navigation-browser-qa.md`. The metadata-only drift
guard is `npm run check:ai-core-browser-qa-evidence`; after running
`npm run qa:seis-core:ai-core-panels`, the stronger artifact gate is
