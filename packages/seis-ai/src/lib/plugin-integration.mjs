  ...
  try {
    ...
    const unifiedSuiteSummary = unifiedSuite
      ? {
          ...
          applicationOwnedPluginCount: unifiedSuite.applicationDistribution?.pluginCount ?? unifiedSuite.publicDistribution?.applicationOwnedPluginCount ?? null,
          applicationPluginIds: unifiedSuite.applicationDistribution?.plugins?.map((plugin) => plugin.moduleId) ?? [],
          applicationPluginSourceRoot: unifiedSuite.applicationDistribution?.sourceRoot ?? null,
          applicationPluginManifest: unifiedSuite.applicationDistribution?.sourceManifest ?? null,
          applicationPluginReleaseTrain: unifiedSuite.applicationDistribution?.releaseTrain ?? null,
          applicationPluginReleaseLabel: unifiedSuite.applicationDistribution?.releaseLabel ?? null,
          applicationPluginReleaseSemver: unifiedSuite.applicationDistribution?.releaseSemver ?? null,
          applicationPluginInstallSurface: unifiedSuite.applicationDistribution?.installSurface ?? null,
          applicationPluginSourceAvailableInRepository: unifiedSuite.applicationDistribution?.sourceAvailableInRepository === true,
          applicationPluginPublicRepositoryAvailable: unifiedSuite.applicationDistribution?.publicRepositoryAvailable === true,
          applicationPluginPublicAudience: unifiedSuite.applicationDistribution?.publicAudience ?? null,
          applicationPluginDistribution: unifiedSuite.applicationDistribution?.publicDistribution ?? null,
          applicationPluginMarketplaceEntryCount: unifiedSuite.applicationDistribution?.marketplaceEntryCount ?? null,
          futurePluginDefaultRule: unifiedSuite.futurePluginIntake?.defaultInstallRule ?? null,
          futureApplicationPluginRule: unifiedSuite.futurePluginIntake?.applicationDefaultInstallRule ?? null,
        }
      : null;
    const payload = {
      ok: true,
      ...
      applicationPluginManifest: unifiedSuiteSummary?.applicationPluginManifest ?? null,
      applicationPluginReleaseTrain: unifiedSuiteSummary?.applicationPluginReleaseTrain ?? null,
      applicationPluginReleaseLabel: unifiedSuiteSummary?.applicationPluginReleaseLabel ?? null,
      applicationPluginReleaseSemver: unifiedSuiteSummary?.applicationPluginReleaseSemver ?? null,
      applicationPluginInstallSurface: unifiedSuiteSummary?.applicationPluginInstallSurface ?? null,
      applicationPluginSourceAvailableInRepository: unifiedSuiteSummary?.applicationPluginSourceAvailableInRepository === true,
      applicationPluginPublicRepositoryAvailable: unifiedSuiteSummary?.applicationPluginPublicRepositoryAvailable === true,
      applicationPluginPublicAudience: unifiedSuiteSummary?.applicationPluginPublicAudience ?? null,
      applicationPluginDistribution: unifiedSuiteSummary?.applicationPluginDistribution ?? null,
      applicationPluginMarketplaceEntryCount: unifiedSuiteSummary?.applicationPluginMarketplaceEntryCount ?? null,
      applicationPluginIds: unifiedSuiteSummary?.applicationPluginIds ?? [],
    ...
    const payload = {
      ...
      externalInstallProof: externalInstallProof
        ? {
            ...
            schemaVersion: externalInstallProof.version ?? null,
            stagedMarketplaceCardCount: externalInstallProof.repoLocalArtifactStaging?.stagedMarketplaceCardCount ?? null,
            stagedSourceCapabilityCount: externalInstallProof.repoLocalArtifactStaging?.stagedSourceCapabilityCount ?? null,
            stagedArtifactCount: externalInstallProof.repoLocalArtifactStaging?.stagedArtifactCount ?? null,
            bundleMembershipExactOnce: externalInstallProof.repoLocalArtifactStaging?.bundleMembershipExactOnce === true,
            maximumBundleSize: externalInstallProof.repoLocalArtifactStaging?.maximumBundleSize ?? null,
