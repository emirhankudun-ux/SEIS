...
- For SEIS plugin, MCP, SEIS-Agent, or cloud/code/design/data lane tasks, call
  ...
  seis_ai_core_model_scaling_status, seis_ai_core_frontier_training_status,
  seis_ai_core_training_evidence_status, seis_ai_core_version_status,
  ...
  execution or release approval. The training-evidence tool is read-only and
  fail-closed: synthetic fixtures validate contracts only and never prove a
  dataset, training run, checkpoint, benchmark, release, route, model ownership,
  or AGI capability. Treat
