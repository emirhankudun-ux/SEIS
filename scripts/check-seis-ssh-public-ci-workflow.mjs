...
ensure((contract?.evidenceSurfaces || []).includes("scripts/create-seis-ssh-public-client-compatibility.mjs"), "contract evidence surfaces must include the client compatibility generator");
ensure((contract?.evidenceSurfaces || []).includes("scripts/create-seis-ssh-public-ai-plugin-review-matrix.mjs"), "contract evidence surfaces must include the AI/plugin review matrix generator");
