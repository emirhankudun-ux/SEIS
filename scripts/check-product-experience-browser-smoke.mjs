...
async function smokeSubAgentFiveYearDemo(client, baseUrl) {
  ...
  ensure(initial.constellationText.includes("34 MCP tools") && initial.constellationText.includes("29 resources"), "SEIS demo constellation inspector missing MCP contract counts");
  ...
  ensure(Number(initial.constellationInspector?.mcpRuntimeResourceCount) === 29, `SEIS demo constellation MCP resource count mismatch: ${initial.constellationInspector?.mcpRuntimeResourceCount}`);
  ...
  ensure(Number(initial.hero3dDiagnostics?.mcpRuntimeResourceCount) === 29, `SEIS demo 3D MCP resource diagnostic count mismatch: ${initial.hero3dDiagnostics?.mcpRuntimeResourceCount}`);
  ...
  ensure(Number(afterExport.mcpRuntimeResourceCount) === 29, `SEIS demo evidence report expected 29 MCP resources, got ${afterExport.mcpRuntimeResourceCount}`);
  ...
  ensure(Number(afterExport.constellationInspectorMcpResourceCount) === 29, `SEIS demo evidence constellation MCP resource count mismatch: ${afterExport.constellationInspectorMcpResourceCount}`);
