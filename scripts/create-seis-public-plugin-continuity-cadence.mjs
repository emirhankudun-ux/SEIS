  ...
  const record = {
    ...
    cadence: {
      ...
      waveSeries: {
        ...
        activeWave: null,
        activeWaveState: "none-pending-wave-4-activation",
      },
      githubDelivery: {
