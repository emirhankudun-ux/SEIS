  ...
  const record = {
    ...
    cadence: {
      ...
      waveSeries: {
        ...
        activeWave: 4,
        activeWaveState: "repository-local-integration-checkpoint-complete-step-81-in-progress",
      },
      githubDelivery: {
    ...
    waves: [
      ...
      },
      {
        ...
        currentEvidencePath: WAVE_4_INTEGRATION_CHECKPOINT_PATH,
