  ...
  const record = {
    ...
    cadence: {
      ...
      waveSeries: {
        ...
        activeWave: 4,
        activeWaveState: "repository-local-validation-delivery-evidence-complete-step-91-in-progress",
      },
      githubDelivery: {
    ...
    waves: [
      ...
      },
      {
        ...
        currentEvidencePath: WAVE_4_VALIDATION_DELIVERY_EVIDENCE_PATH,
