...
function expectedFiles(definition) {
  ...
  const manifest = {
    ...
    license: "UNLICENSED-LOCAL",
    keywords: ["seis", "local", "readonly", ...definition.category.toLowerCase().split(/\s+/)],
    skills: "./skills/",
    mcpServers: "./.mcp.json",
    interface: {
  ...
  const profile = {
    ...
    sourceClassification: "original-SEIS-local",
    license: "UNLICENSED-LOCAL",
    status: "approved-local-readonly",
