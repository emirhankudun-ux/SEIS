...
if (evidenceReport) {
  ...
  ensure(evidenceReport.mcpRuntimeResourceCount === 26, "evidence report must include 26 MCP resources");
...
if (demoPlanView) {
  ...
  ensure(demoPlanView.mcpRuntimeResourceCount === 26, "demo plan view must include 26 MCP resources");
  ensure(
