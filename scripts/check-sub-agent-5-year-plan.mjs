...
if (evidenceReport) {
  ...
  ensure(evidenceReport.mcpRuntimeResourceCount === 20, "evidence report must include 20 MCP resources");
...
if (demoPlanView) {
  ...
  ensure(demoPlanView.mcpRuntimeResourceCount === 20, "demo plan view must include 20 MCP resources");
  ensure(
