...
if (evidenceReport) {
  ...
  ensure(evidenceReport.mcpRuntimeResourceCount === 33, "evidence report must include 33 MCP resources");
...
if (demoPlanView) {
  ...
  ensure(demoPlanView.mcpRuntimeResourceCount === 33, "demo plan view must include 33 MCP resources");
  ensure(
