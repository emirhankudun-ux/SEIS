...
if (evidenceReport) {
  ...
  ensure(evidenceReport.mcpRuntimeResourceCount === 31, "evidence report must include 31 MCP resources");
...
if (demoPlanView) {
  ...
  ensure(demoPlanView.mcpRuntimeResourceCount === 31, "demo plan view must include 31 MCP resources");
  ensure(
