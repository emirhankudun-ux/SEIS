...
for (let index = 0; index < 5; index += 1) {
  ...
  if (index === 0) {
    ...
    ensure(Array.isArray(wave3Program?.steps) && wave3Program.steps.length === 100 && wave3Program.steps.every((step, stepIndex) => step?.status === (stepIndex < 99 ? "completed" : stepIndex === 99 ? "in-progress" : "planned")), "wave 3 step state is invalid");
    ...
    ensure(wave4Program?.id === "seis-public-plugin-wave-4-program" && wave4Program?.status === "planned-gated" && wave4Program?.wave?.number === 4 && wave4Program?.scope?.selectedCapability === "seis-swift-package-topology" && wave4Program?.activationGate?.implementationStarted === false && wave4Program?.activationGate?.candidatePackageExists === false && wave4Program?.activationGate?.candidatePublicCardExists === false, "wave 4 program evidence is invalid");
  } else {
...
ensure(Array.isArray(continuityCadence?.waves) && continuityCadence.waves.length === 5 && continuityCadence.waves[2]?.completedSteps === 99 && Array.isArray(continuityCadence.waves[2]?.inProgressSteps) && continuityCadence.waves[2].inProgressSteps[0] === 100 && continuityCadence.waves[2]?.currentEvidencePath === "content/development/seis-public-plugin-wave-4-program.json" && continuityCadence.waves[3]?.plannedProgramPath === "content/development/seis-public-plugin-wave-4-program.json" && continuityCadence.waves[3]?.selectedCapability === "seis-swift-package-topology" && continuityCadence.waves[3]?.activationApproved === false && Array.isArray(continuityCadence?.futureWaveTemplate?.steps) && continuityCadence.futureWaveTemplate.steps.length === 100, "continuity cadence wave evidence is invalid");
