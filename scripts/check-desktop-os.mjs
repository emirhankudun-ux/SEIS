...
async function runRuntimeSmoke(html, js) {
  ...
  try {
    ...
    ensure(diagnostics.mcpRuntimeContract().resourceCount === 33, `MCP Runtime Contract diagnostics expected 33 resources, got ${diagnostics.mcpRuntimeContract().resourceCount}.`);
