...
if (!installTrainingLedger || !modelScalingProfile || !agiEvaluationProtocol || !packageJson) {
  process.exit(1);
}
...
function buildContract({ generatedAt, installTrainingLedger, modelScalingProfile, agiEvaluationProtocol }) {
  return {
