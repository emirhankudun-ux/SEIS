...
for (const [file, required] of [
  ...
  ["docs/governance/github-market-readiness.md", "Do not install unused language runtimes by default"],
  ...
  ["docs/governance/seis-master-prompt.md", "Do not deploy, merge, push, delete, or rewrite history without explicit user approval"],
