...
function buildReport(targetAlias) {
  ...
  if (sshConfig.transport === "local-or-lan") failures.push("SEIS-SSH must not resolve to localhost, private LAN, or .local addresses");
  ...
  return {
    ...
    safety: [
      ...
      "This report does not write ~/.ssh/config.",
