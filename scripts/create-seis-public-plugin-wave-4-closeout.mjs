...
function buildRecord() {
  ...
  const record = {
    ...
    purpose: "Close the current 100-step Wave 4 program with repository-local, public-only evidence while keeping Wave 5 planned-gated. This records no package or card addition, no personal marketplace access, no protected-default-branch write, no publication, and no installation, compiler, runtime, provider, deployment, signing, or release claim.",
    stateAtCheckpoint: {
    ...
    risks: [
      ...
      },
      {
        id: "RISK-W4-026",
        status: "tracked",
        description: "The selected Wave 5 candidate could be activated by implication when Wave 4 closes.",
        mitigation: "Record nextWaveStatus=planned-gated and implementation/activation=false; require a separate Wave 5 scope and activation decision.",
      },
    ],
    rollback: {
      strategy: "revert",
