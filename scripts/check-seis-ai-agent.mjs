...
for (const name of ["seis", "seis-governance", "seis-cloud", "seis-code", "seis-design", "seis-data"]) ensure(profile?.composedLanes?.includes(name), `profile missing lane ${name}`);
for (const name of ["seis-ai-agent", "seis-governance", "seis-hub", "seis-cloud", "seis-code", "seis-design", "seis-data"]) ensure(profile?.consolidationPolicy?.embeddedSkills?.includes(name), `profile missing embedded skill ${name}`);
...
for (const tool of ["seis_hub_status", "seis_hub_plan", "seis_governance_status", "seis_governance_plan", "seis_cloud_status", "seis_cloud_plan", "seis_code_status", "seis_code_plan", "seis_design_status", "seis_design_plan", "seis_data_status", "seis_data_plan"]) {
...
function validateMcpSmoke() {
  ...
  for (const tool of ["seis_agent_lanes", "seis_governance_status", "seis_governance_plan", "seis_cloud_status", "seis_cloud_plan", "seis_code_status", "seis_design_status", "seis_data_status", "seis_data_plan"]) {
  ...
  ensure(lanes?.status === "ready" && lanes?.laneCount === 6, "MCP lane inventory must report six embedded lanes");
