...
const files = {
  ...
  readinessReportTest: "scripts/tests/seis-ssh-mobile-24x7-report.test.mjs",
...
for (const [file, token] of [
  ...
  [files.runbook, "claimGate"],
  [files.runbook, "handoffReplay"],
  [files.runbook, "readyClaimAllowed"],
  [files.runbook, "macOffClaimAllowed"],
  [files.runbook, "replayableOnNewDevice"],
  ...
  [files.readinessReport, "--readiness-json"],
  [files.readinessReport, "claimGate"],
  [files.readinessReport, "handoffReplay"],
  [files.readinessReport, "evidenceManifest"],
  [files.readinessReport, "strictDoctorRequested"],
  [files.readinessReport, "strictDoctorPassed"],
  [files.readinessReport, "readyClaimAllowed"],
  [files.readinessReport, "continuityClaimAllowed"],
  [files.readinessReport, "macOffClaimAllowed"],
  [files.readinessReport, "replayableOnNewDevice"],
  [files.readinessReport, "requiresDirectCloudTransport"],
  [files.readinessReport, "sourceLedger"],
  [files.readinessReport, "browserLocalProofAllowed"],
  [files.readinessReport, "SEIS remains reachable when the local Mac is closed"],
  [files.readinessReportTest, "readyClaimAllowed, false"],
  [files.readinessReportTest, "macOffClaimAllowed, false"],
  [files.readinessReportTest, "strictDoctorRequested, false"],
  [files.readinessReportTest, "strictDoctorPassed, true"],
  [files.readinessReportTest, "replayableOnNewDevice, false"],
  [files.readinessReportTest, "replayableOnNewDevice, true"],
  [files.readinessReportTest, "strict-doctor-required"],
  [files.readinessReportTest, "browserLocalProofAllowed"],
