...
- Root workspace instructions from `/Users/emirhan/Library/Mobile Documents/com~apple~CloudDocs/Github/AGENTS.md`.
- The attached SEIS Supreme operating-system directive.
- The iCloud Drive `Github` workspace inventory.
- The existing UIX-Apps `AGENTS.md`, branch governance, and low-power development process.
...
Broad instructions, operating-system language, workspace routing, and repository-governance rules should become traceable documentation. Code, app surfaces, and assets should be imported only after a focused review confirms they belong in UIX-Apps.
...
| Active UIX-Apps code | `apps`, `scripts`, `docs`, `content`, `reports` | Merge through normal Git review and focused checks. |
