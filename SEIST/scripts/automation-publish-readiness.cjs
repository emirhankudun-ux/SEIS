...
print(`- expected branch (UIXAppTTR): ${state.isExpectedBranch ? "yes" : "no"}`);
...
print(`- expected upstream (origin/UIXAppTTR): ${state.hasUpstream && state.isExpectedUpstream ? "yes" : "no"}`);
